...
_strace:     formato del fichero elf32-i386
   ...
   f:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  21:	e8 5a 04 00 00       	call   480 <printf>
    exit();
  26:	e8 f8 02 00 00       	call   323 <exit>
  }
  
  if(strcmp(argv[1], "on") == 0) {
  2b:	50                   	push   %eax
  2c:	50                   	push   %eax
  2d:	68 be 07 00 00       	push   $0x7be
  32:	ff 73 04             	push   0x4(%ebx)
  35:	e8 c6 00 00 00       	call   100 <strcmp>
  3a:	83 c4 10             	add    $0x10,%esp
  3d:	85 c0                	test   %eax,%eax
  3f:	74 3d                	je     7e <main+0x7e>
  ...
  41:	51                   	push   %ecx
  42:	51                   	push   %ecx
  43:	68 f1 07 00 00       	push   $0x7f1
  48:	ff 73 04             	push   0x4(%ebx)
  4b:	e8 b0 00 00 00       	call   100 <strcmp>
  50:	83 c4 10             	add    $0x10,%esp
  53:	85 c0                	test   %eax,%eax
  55:	75 c0                	jne    17 <main+0x17>
    if(trace(0) < 0) {
  57:	83 ec 0c             	sub    $0xc,%esp
  5a:	6a 00                	push   $0x0
  5c:	e8 62 03 00 00       	call   3c3 <trace>
  61:	83 c4 10             	add    $0x10,%esp
  64:	85 c0                	test   %eax,%eax
  66:	78 4d                	js     b5 <main+0xb5>
  ...
  68:	50                   	push   %eax
  69:	50                   	push   %eax
  6a:	68 13 08 00 00       	push   $0x813
  6f:	6a 01                	push   $0x1
  71:	e8 0a 04 00 00       	call   480 <printf>
  ...
  81:	6a 01                	push   $0x1
  83:	e8 3b 03 00 00       	call   3c3 <trace>
  88:	83 c4 10             	add    $0x10,%esp
  8b:	85 c0                	test   %eax,%eax
  8d:	78 13                	js     a2 <main+0xa2>
    printf(1, "Syscall tracing: ON\n");
  8f:	53                   	push   %ebx
  90:	53                   	push   %ebx
  91:	68 dc 07 00 00       	push   $0x7dc
  96:	6a 01                	push   $0x1
  98:	e8 e3 03 00 00       	call   480 <printf>
  9d:	83 c4 10             	add    $0x10,%esp
  a0:	eb d7                	jmp    79 <main+0x79>
      printf(2, "Error: No se pudo activar\n");
  a2:	50                   	push   %eax
  a3:	50                   	push   %eax
  a4:	68 c1 07 00 00       	push   $0x7c1
  a9:	6a 02                	push   $0x2
  ab:	e8 d0 03 00 00       	call   480 <printf>
      exit();
  b0:	e8 6e 02 00 00       	call   323 <exit>
      printf(2, "Error: No se pudo desactivar\n");
  b5:	52                   	push   %edx
  b6:	52                   	push   %edx
  b7:	68 f5 07 00 00       	push   $0x7f5
  bc:	6a 02                	push   $0x2
  be:	e8 bd 03 00 00       	call   480 <printf>
      exit();
  c3:	e8 5b 02 00 00       	call   323 <exit>
  c8:	66 90                	xchg   %ax,%ax
  ca:	66 90                	xchg   %ax,%ax
  cc:	66 90                	xchg   %ax,%ax
  ce:	66 90                	xchg   %ax,%ax
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 30 08 00 00 	jmp    *0x830(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba 29 08 00 00       	mov    $0x829,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 34 0b 00 00       	mov    0xb34,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 34 0b 00 00    	mov    %edx,0xb34
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 34 0b 00 00    	mov    %edx,0xb34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 34 0b 00 00    	mov    0xb34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 34 0b 00 00    	mov    0xb34,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 34 0b 00 00    	mov    0xb34,%edx
 ...
 75c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 75f:	89 15 34 0b 00 00    	mov    %edx,0xb34
}
 ...
 76f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 34 0b 00 00 38 	movl   $0xb38,0xb34
 777:	0b 00 00 
    base.s.size = 0;
 77a:	bf 38 0b 00 00       	mov    $0xb38,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 38 0b 00 00 38 	movl   $0xb38,0xb38
 786:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 3c 0b 00 00 00 	movl   $0x0,0xb3c
 792:	00 00 00 
    if(p->s.size >= nunits){
