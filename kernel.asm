...
801001a1:	68 8e 73 10 80       	push   $0x8010738e
...
8010023f:	89 50 54             	mov    %edx,0x54(%eax)
    b->next = bcache.head.next;
80100242:	a1 d0 ec 10 80       	mov    0x8010ecd0,%eax
    b->prev = &bcache.head;
80100247:	c7 43 50 7c ec 10 80 	movl   $0x8010ec7c,0x50(%ebx)
    b->next = bcache.head.next;
8010024e:	89 43 54             	mov    %eax,0x54(%ebx)
    bcache.head.next->prev = b;
80100251:	a1 d0 ec 10 80       	mov    0x8010ecd0,%eax
80100256:	89 58 50             	mov    %ebx,0x50(%eax)
    bcache.head.next = b;
80100259:	89 1d d0 ec 10 80    	mov    %ebx,0x8010ecd0
  }
  
  release(&bcache.lock);
8010025f:	c7 45 08 80 a5 10 80 	movl   $0x8010a580,0x8(%ebp)
}
...
801002b5:	3b 05 64 ef 10 80    	cmp    0x8010ef64,%eax
...
80100505:	e8 86 59 00 00       	call   80105e90 <uartputc>
8010050a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100511:	e8 7a 59 00 00       	call   80105e90 <uartputc>
80100516:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010051d:	e8 6e 59 00 00       	call   80105e90 <uartputc>
...
8010059f:	e8 bc 12 00 00       	call   80101860 <iunlock>
  acquire(&cons.lock);
801005a4:	c7 04 24 80 ef 10 80 	movl   $0x8010ef80,(%esp)
...
801005ba:	8d 3c 33             	lea    (%ebx,%esi,1),%edi
  if(panicked){
801005bd:	8b 15 b8 ef 10 80    	mov    0x8010efb8,%edx
    consputc(buf[i] & 0xff);
...
801005df:	68 80 ef 10 80       	push   $0x8010ef80
...
80100636:	0f b6 92 f0 73 10 80 	movzbl -0x7fef8c10(%edx),%edx
  }while((x /= base) != 0);
...
8010065f:	0f be c2             	movsbl %dl,%eax
  if(panicked){
80100662:	8b 15 b8 ef 10 80    	mov    0x8010efb8,%edx
...
801006a9:	a1 b4 ef 10 80       	mov    0x8010efb4,%eax
...
8010075a:	0f 84 08 01 00 00    	je     80100868 <cprintf+0x1c8>
  if(panicked){
80100760:	8b 15 b8 ef 10 80    	mov    0x8010efb8,%edx
...
801007a5:	8d 76 00             	lea    0x0(%esi),%esi
  if(panicked){
801007a8:	8b 0d b8 ef 10 80    	mov    0x8010efb8,%ecx
...
801007b5:	8d 76 00             	lea    0x0(%esi),%esi
  if(panicked){
801007b8:	a1 b8 ef 10 80       	mov    0x8010efb8,%eax
...
801007e3:	68 80 ef 10 80       	push   $0x8010ef80
801007e8:	e8 b3 3d 00 00       	call   801045a0 <acquire>
801007ed:	83 c4 10             	add    $0x10,%esp
801007f0:	e9 c4 fe ff ff       	jmp    801006b9 <cprintf+0x19>
  if(panicked){
801007f5:	8b 0d b8 ef 10 80    	mov    0x8010efb8,%ecx
801007fb:	85 c9                	test   %ecx,%ecx
801007fd:	75 31                	jne    80100830 <cprintf+0x190>
801007ff:	b8 25 00 00 00       	mov    $0x25,%eax
80100804:	89 55 e0             	mov    %edx,-0x20(%ebp)
80100807:	e8 f4 fb ff ff       	call   80100400 <consputc.part.0>
8010080c:	8b 15 b8 ef 10 80    	mov    0x8010efb8,%edx
...
80100837:	90                   	nop
        s = "(null)";
80100838:	bf d8 73 10 80       	mov    $0x801073d8,%edi
      for(; *s; s++)
...
80100856:	68 80 ef 10 80       	push   $0x8010ef80
...
80100873:	68 df 73 10 80       	push   $0x801073df
...
8010088b:	8b 7d 08             	mov    0x8(%ebp),%edi
  acquire(&cons.lock);
8010088e:	68 80 ef 10 80       	push   $0x8010ef80
...
801008d3:	a1 68 ef 10 80       	mov    0x8010ef68,%eax
801008d8:	89 c2                	mov    %eax,%edx
801008da:	2b 15 60 ef 10 80    	sub    0x8010ef60,%edx
801008e0:	83 fa 7f             	cmp    $0x7f,%edx
801008e3:	77 d2                	ja     801008b7 <consoleintr+0x37>
        input.buf[input.e++ % INPUT_BUF] = c;
801008e5:	8d 48 01             	lea    0x1(%eax),%ecx
  if(panicked){
801008e8:	8b 15 b8 ef 10 80    	mov    0x8010efb8,%edx
        input.buf[input.e++ % INPUT_BUF] = c;
801008ee:	83 e0 7f             	and    $0x7f,%eax
801008f1:	89 0d 68 ef 10 80    	mov    %ecx,0x8010ef68
        c = (c == '\r') ? '\n' : c;
801008f7:	83 fb 0d             	cmp    $0xd,%ebx
801008fa:	0f 84 13 01 00 00    	je     80100a13 <consoleintr+0x193>
        input.buf[input.e++ % INPUT_BUF] = c;
80100900:	88 98 e0 ee 10 80    	mov    %bl,-0x7fef1120(%eax)
  if(panicked){
...
80100927:	a1 60 ef 10 80       	mov    0x8010ef60,%eax
8010092c:	83 e8 80             	sub    $0xffffff80,%eax
8010092f:	39 05 68 ef 10 80    	cmp    %eax,0x8010ef68
80100935:	75 80                	jne    801008b7 <consoleintr+0x37>
80100937:	e9 fb 00 00 00       	jmp    80100a37 <consoleintr+0x1b7>
8010093c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      while(input.e != input.w &&
80100940:	a1 68 ef 10 80       	mov    0x8010ef68,%eax
80100945:	39 05 64 ef 10 80    	cmp    %eax,0x8010ef64
...
80100956:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100959:	80 ba e0 ee 10 80 0a 	cmpb   $0xa,-0x7fef1120(%edx)
80100960:	0f 84 51 ff ff ff    	je     801008b7 <consoleintr+0x37>
  if(panicked){
80100966:	8b 15 b8 ef 10 80    	mov    0x8010efb8,%edx
        input.e--;
8010096c:	a3 68 ef 10 80       	mov    %eax,0x8010ef68
  if(panicked){
...
8010097f:	90                   	nop
      if(input.e != input.w){
80100980:	a1 68 ef 10 80       	mov    0x8010ef68,%eax
80100985:	3b 05 64 ef 10 80    	cmp    0x8010ef64,%eax
8010098b:	0f 84 26 ff ff ff    	je     801008b7 <consoleintr+0x37>
        input.e--;
80100991:	83 e8 01             	sub    $0x1,%eax
80100994:	a3 68 ef 10 80       	mov    %eax,0x8010ef68
  if(panicked){
80100999:	a1 b8 ef 10 80       	mov    0x8010efb8,%eax
...
801009ad:	e8 4e fa ff ff       	call   80100400 <consputc.part.0>
      while(input.e != input.w &&
801009b2:	a1 68 ef 10 80       	mov    0x8010ef68,%eax
801009b7:	3b 05 64 ef 10 80    	cmp    0x8010ef64,%eax
801009bd:	75 92                	jne    80100951 <consoleintr+0xd1>
801009bf:	e9 f3 fe ff ff       	jmp    801008b7 <consoleintr+0x37>
801009c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&cons.lock);
801009c8:	83 ec 0c             	sub    $0xc,%esp
801009cb:	68 80 ef 10 80       	push   $0x8010ef80
...
80100a0e:	e9 cd 37 00 00       	jmp    801041e0 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
80100a13:	c6 80 e0 ee 10 80 0a 	movb   $0xa,-0x7fef1120(%eax)
  if(panicked){
...
80100a2d:	e8 ce f9 ff ff       	call   80100400 <consputc.part.0>
          input.w = input.e;
80100a32:	a1 68 ef 10 80       	mov    0x8010ef68,%eax
          wakeup(&input.r);
80100a37:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
80100a3a:	a3 64 ef 10 80       	mov    %eax,0x8010ef64
          wakeup(&input.r);
80100a3f:	68 60 ef 10 80       	push   $0x8010ef60
...
80100a66:	68 e8 73 10 80       	push   $0x801073e8
...
80100a79:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
80100a7b:	c7 05 6c f9 10 80 90 	movl   $0x80100590,0x8010f96c
80100a82:	05 10 80 
  devsw[CONSOLE].read = consoleread;
...
80100b32:	75 d2                	jne    80100b06 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100b34:	e8 e7 64 00 00       	call   80107020 <setupkvm>
...
80100ba3:	e8 98 62 00 00       	call   80106e40 <allocuvm>
...
80100bd9:	e8 72 61 00 00       	call   80106d50 <loaduvm>
...
80100c1b:	e8 80 63 00 00       	call   80106fa0 <freevm>
  if(ip){
...
80100c62:	e8 d9 61 00 00       	call   80106e40 <allocuvm>
...
80100cf8:	e8 93 65 00 00       	call   80107290 <copyout>
...
80100d11:	e8 8a 62 00 00       	call   80106fa0 <freevm>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 28 65 00 00       	call   80107290 <copyout>
...
80100dcd:	e8 ee 5d 00 00       	call   80106bc0 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 c6 61 00 00       	call   80106fa0 <freevm>
  return 0;
...
80100dec:	68 01 74 10 80       	push   $0x80107401
...
80100e16:	68 0d 74 10 80       	push   $0x8010740d
80100e1b:	68 c0 ef 10 80       	push   $0x8010efc0
...
80100e34:	bb f4 ef 10 80       	mov    $0x8010eff4,%ebx
{
80100e39:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100e3c:	68 c0 ef 10 80       	push   $0x8010efc0
...
80100e53:	81 fb 54 f9 10 80    	cmp    $0x8010f954,%ebx
...
80100e65:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100e6c:	68 c0 ef 10 80       	push   $0x8010efc0
...
80100e83:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100e85:	68 c0 ef 10 80       	push   $0x8010efc0
...
80100ea7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100eaa:	68 c0 ef 10 80       	push   $0x8010efc0
...
80100ec4:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100ec7:	68 c0 ef 10 80       	push   $0x8010efc0
...
80100edb:	68 14 74 10 80       	push   $0x80107414
...
80100ef9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100efc:	68 c0 ef 10 80       	push   $0x8010efc0
...
80100f31:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100f34:	68 c0 ef 10 80       	push   $0x8010efc0
  ff = *f;
...
80100f5d:	8d 76 00             	lea    0x0(%esi),%esi
    release(&ftable.lock);
80100f60:	c7 45 08 c0 ef 10 80 	movl   $0x8010efc0,0x8(%ebp)
}
...
80100fbc:	68 1c 74 10 80       	push   $0x8010741c
...
801010a2:	68 26 74 10 80       	push   $0x80107426
...
80101177:	68 2f 74 10 80       	push   $0x8010742f
...
801011b1:	68 35 74 10 80       	push   $0x80107435
...
801011c8:	03 05 2c 16 11 80    	add    0x8011162c,%eax
{
...
80101227:	68 3f 74 10 80       	push   $0x8010743f
...
80101249:	8b 0d 14 16 11 80    	mov    0x80111614,%ecx
{
...
8010126c:	03 05 2c 16 11 80    	add    0x8011162c,%eax
...
80101281:	a1 14 16 11 80       	mov    0x80111614,%eax
...
801012d9:	39 05 14 16 11 80    	cmp    %eax,0x80111614
801012df:	77 80                	ja     80101261 <balloc+0x21>
  panic("balloc: out of blocks");
801012e1:	83 ec 0c             	sub    $0xc,%esp
801012e4:	68 52 74 10 80       	push   $0x80107452
...
8010135a:	bb f4 f9 10 80       	mov    $0x8010f9f4,%ebx
{
8010135f:	83 ec 28             	sub    $0x28,%esp
80101362:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
80101365:	68 c0 f9 10 80       	push   $0x8010f9c0
...
8010138a:	81 fb 14 16 11 80    	cmp    $0x80111614,%ebx
...
801013a9:	81 fb 14 16 11 80    	cmp    $0x80111614,%ebx
...
801013cb:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
801013d2:	68 c0 f9 10 80       	push   $0x8010f9c0
...
801013fb:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
801013fd:	68 c0 f9 10 80       	push   $0x8010f9c0
      ip->ref++;
...
8010141d:	81 fb 14 16 11 80    	cmp    $0x80111614,%ebx
...
80101438:	68 68 74 10 80       	push   $0x80107468
...
80101515:	68 78 74 10 80       	push   $0x80107478
...
80101564:	bb 00 fa 10 80       	mov    $0x8010fa00,%ebx
80101569:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
8010156c:	68 8b 74 10 80       	push   $0x8010748b
80101571:	68 c0 f9 10 80       	push   $0x8010f9c0
...
80101583:	68 92 74 10 80       	push   $0x80107492
...
80101597:	81 fb 20 16 11 80    	cmp    $0x80111620,%ebx
...
801015b7:	68 14 16 11 80       	push   $0x80111614
801015bc:	e8 3f 31 00 00       	call   80104700 <memmove>
  brelse(bp);
801015c1:	89 1c 24             	mov    %ebx,(%esp)
801015c4:	e8 27 ec ff ff       	call   801001f0 <brelse>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801015c9:	ff 35 2c 16 11 80    	push   0x8011162c
801015cf:	ff 35 28 16 11 80    	push   0x80111628
801015d5:	ff 35 24 16 11 80    	push   0x80111624
801015db:	ff 35 20 16 11 80    	push   0x80111620
801015e1:	ff 35 1c 16 11 80    	push   0x8011161c
801015e7:	ff 35 18 16 11 80    	push   0x80111618
801015ed:	ff 35 14 16 11 80    	push   0x80111614
801015f3:	68 f8 74 10 80       	push   $0x801074f8
...
8010161c:	83 3d 1c 16 11 80 01 	cmpl   $0x1,0x8011161c
{
...
8010164f:	3b 3d 1c 16 11 80    	cmp    0x8011161c,%edi
80101655:	73 69                	jae    801016c0 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101657:	89 f8                	mov    %edi,%eax
80101659:	83 ec 08             	sub    $0x8,%esp
8010165c:	c1 e8 03             	shr    $0x3,%eax
8010165f:	03 05 28 16 11 80    	add    0x80111628,%eax
...
801016c3:	68 98 74 10 80       	push   $0x80107498
...
801016e4:	03 05 28 16 11 80    	add    0x80111628,%eax
...
80101757:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010175a:	68 c0 f9 10 80       	push   $0x8010f9c0
8010175f:	e8 3c 2e 00 00       	call   801045a0 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 c0 f9 10 80 	movl   $0x8010f9c0,(%esp)
...
801017c9:	03 05 28 16 11 80    	add    0x80111628,%eax
...
8010183d:	68 b0 74 10 80       	push   $0x801074b0
80101842:	e8 39 eb ff ff       	call   80100380 <panic>
    panic("ilock");
80101847:	83 ec 0c             	sub    $0xc,%esp
8010184a:	68 aa 74 10 80       	push   $0x801074aa
...
80101897:	68 bf 74 10 80       	push   $0x801074bf
...
801018da:	e8 61 2a 00 00       	call   80104340 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 c0 f9 10 80 	movl   $0x8010f9c0,(%esp)
801018e6:	e8 b5 2c 00 00       	call   801045a0 <acquire>
  ip->ref--;
801018eb:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801018ef:	83 c4 10             	add    $0x10,%esp
801018f2:	c7 45 08 c0 f9 10 80 	movl   $0x8010f9c0,0x8(%ebp)
}
...
8010190b:	68 c0 f9 10 80       	push   $0x8010f9c0
80101910:	e8 8b 2c 00 00       	call   801045a0 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 c0 f9 10 80 	movl   $0x8010f9c0,(%esp)
...
80101a53:	68 bf 74 10 80       	push   $0x801074bf
...
80101b6a:	8b 04 c5 60 f9 10 80 	mov    -0x7fef06a0(,%eax,8),%eax
...
80101c7a:	8b 04 c5 64 f9 10 80 	mov    -0x7fef069c(,%eax,8),%eax
...
80101d72:	68 d9 74 10 80       	push   $0x801074d9
80101d77:	e8 04 e6 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
80101d7c:	83 ec 0c             	sub    $0xc,%esp
80101d7f:	68 c7 74 10 80       	push   $0x801074c7
...
80101db2:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101db5:	68 c0 f9 10 80       	push   $0x8010f9c0
80101dba:	e8 e1 27 00 00       	call   801045a0 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 c0 f9 10 80 	movl   $0x8010f9c0,(%esp)
...
80101fcf:	68 bf 74 10 80       	push   $0x801074bf
...
8010207b:	68 e8 74 10 80       	push   $0x801074e8
80102080:	e8 fb e2 ff ff       	call   80100380 <panic>
    panic("dirlink");
80102085:	83 ec 0c             	sub    $0xc,%esp
80102088:	68 02 7c 10 80       	push   $0x80107c02
...
8010219b:	68 54 75 10 80       	push   $0x80107554
801021a0:	e8 db e1 ff ff       	call   80100380 <panic>
    panic("idestart");
801021a5:	83 ec 0c             	sub    $0xc,%esp
801021a8:	68 4b 75 10 80       	push   $0x8010754b
...
801021c6:	68 66 75 10 80       	push   $0x80107566
801021cb:	68 60 16 11 80       	push   $0x80111660
801021d0:	e8 fb 21 00 00       	call   801043d0 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
801021d5:	58                   	pop    %eax
801021d6:	a1 e4 17 11 80       	mov    0x801117e4,%eax
801021db:	5a                   	pop    %edx
...
80102218:	74 f6                	je     80102210 <ideinit+0x50>
      havedisk1 = 1;
8010221a:	c7 05 40 16 11 80 01 	movl   $0x1,0x80111640
80102221:	00 00 00 
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
80102246:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&idelock);
80102249:	68 60 16 11 80       	push   $0x80111660
8010224e:	e8 4d 23 00 00       	call   801045a0 <acquire>

  if((b = idequeue) == 0){
80102253:	8b 1d 44 16 11 80    	mov    0x80111644,%ebx
...
80102263:	a3 44 16 11 80       	mov    %eax,0x80111644
...
801022ad:	e8 4e 1e 00 00       	call   80104100 <wakeup>
  ...
  if(idequeue != 0)
801022b2:	a1 44 16 11 80       	mov    0x80111644,%eax
...
801022c6:	68 60 16 11 80       	push   $0x80111660
...
80102313:	a1 40 16 11 80       	mov    0x80111640,%eax
...
80102323:	68 60 16 11 80       	push   $0x80111660
80102328:	e8 73 22 00 00       	call   801045a0 <acquire>

  // Append b to idequeue.
  b->qnext = 0;
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
8010232d:	a1 44 16 11 80       	mov    0x80111644,%eax
  b->qnext = 0;
...
8010234c:	89 1a                	mov    %ebx,(%edx)
  ...
  if(idequeue == b)
8010234e:	39 1d 44 16 11 80    	cmp    %ebx,0x80111644
...
80102363:	68 60 16 11 80       	push   $0x80111660
...
80102379:	75 e5                	jne    80102360 <iderw+0x80>
  ...
  release(&idelock);
8010237b:	c7 45 08 60 16 11 80 	movl   $0x80111660,0x8(%ebp)
}
...
80102399:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
801023a0:	ba 44 16 11 80       	mov    $0x80111644,%edx
801023a5:	eb a5                	jmp    8010234c <iderw+0x6c>
    panic("iderw: ide disk 1 not present");
801023a7:	83 ec 0c             	sub    $0xc,%esp
801023aa:	68 95 75 10 80       	push   $0x80107595
801023af:	e8 cc df ff ff       	call   80100380 <panic>
    panic("iderw: nothing to do");
801023b4:	83 ec 0c             	sub    $0xc,%esp
801023b7:	68 80 75 10 80       	push   $0x80107580
801023bc:	e8 bf df ff ff       	call   80100380 <panic>
    panic("iderw: buf not locked");
801023c1:	83 ec 0c             	sub    $0xc,%esp
801023c4:	68 6a 75 10 80       	push   $0x8010756a
...
801023d1:	c7 05 94 16 11 80 00 	movl   $0xfec00000,0x80111694
801023d8:	00 c0 fe 
{
...
801023e6:	00 00 00 
  return ioapic->data;
801023e9:	8b 15 94 16 11 80    	mov    0x80111694,%edx
801023ef:	8b 72 10             	mov    0x10(%edx),%esi
  ioapic->reg = reg;
801023f2:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
801023f8:	8b 0d 94 16 11 80    	mov    0x80111694,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
801023fe:	0f b6 15 e0 17 11 80 	movzbl 0x801117e0,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
8010241a:	68 b4 75 10 80       	push   $0x801075b4
8010241f:	e8 7c e2 ff ff       	call   801006a0 <cprintf>
  ioapic->reg = reg;
80102424:	8b 0d 94 16 11 80    	mov    0x80111694,%ecx
...
80102442:	89 c3                	mov    %eax,%ebx
  ioapic->data = data;
80102444:	8b 0d 94 16 11 80    	mov    0x80111694,%ecx
  for(i = 0; i <= maxintr; i++){
...
8010245c:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
8010245e:	8b 0d 94 16 11 80    	mov    0x80111694,%ecx
...
80102480:	55                   	push   %ebp
  ioapic->reg = reg;
80102481:	8b 0d 94 16 11 80    	mov    0x80111694,%ecx
{
...
80102493:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102495:	8b 0d 94 16 11 80    	mov    0x80111694,%ecx
...
801024a4:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801024a6:	a1 94 16 11 80       	mov    0x80111694,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
801024d2:	81 fb 30 55 11 80    	cmp    $0x80115530,%ebx
...
801024f2:	e8 69 21 00 00       	call   80104660 <memset>
  ...
  if(kmem.use_lock)
801024f7:	8b 15 d4 16 11 80    	mov    0x801116d4,%edx
...
80102504:	a1 d8 16 11 80       	mov    0x801116d8,%eax
80102509:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010250b:	a1 d4 16 11 80       	mov    0x801116d4,%eax
  kmem.freelist = r;
80102510:	89 1d d8 16 11 80    	mov    %ebx,0x801116d8
  if(kmem.use_lock)
...
80102523:	68 a0 16 11 80       	push   $0x801116a0
80102528:	e8 73 20 00 00       	call   801045a0 <acquire>
8010252d:	83 c4 10             	add    $0x10,%esp
80102530:	eb d2                	jmp    80102504 <kfree+0x44>
80102532:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&kmem.lock);
80102538:	c7 45 08 a0 16 11 80 	movl   $0x801116a0,0x8(%ebp)
}
...
8010254b:	68 e6 75 10 80       	push   $0x801075e6
...
801025f2:	73 e4                	jae    801025d8 <kinit2+0x28>
  kmem.use_lock = 1;
801025f4:	c7 05 d4 16 11 80 01 	movl   $0x1,0x801116d4
801025fb:	00 00 00 
}
...
8010261b:	68 ec 75 10 80       	push   $0x801075ec
80102620:	68 a0 16 11 80       	push   $0x801116a0
...
8010262d:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102630:	c7 05 d4 16 11 80 00 	movl   $0x0,0x801116d4
80102637:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
kalloc(void)
{
  ...
  if(kmem.use_lock)
80102680:	a1 d4 16 11 80       	mov    0x801116d4,%eax
80102685:	85 c0                	test   %eax,%eax
80102687:	75 1f                	jne    801026a8 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
80102689:	a1 d8 16 11 80       	mov    0x801116d8,%eax
  if(r)
8010268e:	85 c0                	test   %eax,%eax
80102690:	74 0e                	je     801026a0 <kalloc+0x20>
    kmem.freelist = r->next;
80102692:	8b 10                	mov    (%eax),%edx
80102694:	89 15 d8 16 11 80    	mov    %edx,0x801116d8
  if(kmem.use_lock)
8010269a:	c3                   	ret    
...
801026ab:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
801026ae:	68 a0 16 11 80       	push   $0x801116a0
801026b3:	e8 e8 1e 00 00       	call   801045a0 <acquire>
  r = kmem.freelist;
801026b8:	a1 d8 16 11 80       	mov    0x801116d8,%eax
  if(kmem.use_lock)
801026bd:	8b 15 d4 16 11 80    	mov    0x801116d4,%edx
  if(r)
...
801026cc:	89 0d d8 16 11 80    	mov    %ecx,0x801116d8
  if(kmem.use_lock)
...
801026dc:	68 a0 16 11 80       	push   $0x801116a0
...
80102707:	ec                   	in     (%dx),%al
  ...
  if(data == 0xE0){
    shift |= E0ESC;
80102708:	8b 1d dc 16 11 80    	mov    0x801116dc,%ebx
  data = inb(KBDATAP);
...
8010272b:	0f b6 91 20 77 10 80 	movzbl -0x7fef88e0(%ecx),%edx
  shift ^= togglecode[data];
80102732:	0f b6 81 20 76 10 80 	movzbl -0x7fef89e0(%ecx),%eax
  shift |= shiftcode[data];
...
8010273d:	89 d0                	mov    %edx,%eax
  shift ^= togglecode[data];
8010273f:	89 15 dc 16 11 80    	mov    %edx,0x801116dc
  c = charcode[shift & (CTL | SHIFT)][data];
80102745:	83 e0 03             	and    $0x3,%eax
  if(shift & CAPSLOCK){
80102748:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010274b:	8b 04 85 00 76 10 80 	mov    -0x7fef8a00(,%eax,4),%eax
...
80102773:	31 c0                	xor    %eax,%eax
    shift |= E0ESC;
80102775:	89 1d dc 16 11 80    	mov    %ebx,0x801116dc
}
...
80102785:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102788:	0f b6 81 20 77 10 80 	movzbl -0x7fef88e0(%ecx),%eax
...
80102799:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    shift &= ~(shiftcode[data] | E0ESC);
8010279c:	a3 dc 16 11 80       	mov    %eax,0x801116dc
    return 0;
...
{
  if(!lapic)
801027f0:	a1 e0 16 11 80       	mov    0x801116e0,%eax
...
{
  if(lapic)
80102910:	a1 e0 16 11 80       	mov    0x801116e0,%eax
...
80102978:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
8010297e:	a1 e0 16 11 80       	mov    0x801116e0,%eax
...
80102bc0:	8b 0d 48 17 11 80    	mov    0x80111748,%ecx
...
80102be0:	a1 34 17 11 80       	mov    0x80111734,%eax
80102be5:	83 ec 08             	sub    $0x8,%esp
80102be8:	01 f8                	add    %edi,%eax
80102bea:	83 c0 01             	add    $0x1,%eax
80102bed:	50                   	push   %eax
80102bee:	ff 35 44 17 11 80    	push   0x80111744
80102bf4:	e8 d7 d4 ff ff       	call   801000d0 <bread>
80102bf9:	89 c6                	mov    %eax,%esi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102bfb:	58                   	pop    %eax
80102bfc:	5a                   	pop    %edx
80102bfd:	ff 34 bd 4c 17 11 80 	push   -0x7feee8b4(,%edi,4)
80102c04:	ff 35 44 17 11 80    	push   0x80111744
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102c44:	39 3d 48 17 11 80    	cmp    %edi,0x80111748
...
80102c67:	ff 35 34 17 11 80    	push   0x80111734
80102c6d:	ff 35 44 17 11 80    	push   0x80111744
...
80102c7b:	89 c3                	mov    %eax,%ebx
  hb->n = log.lh.n;
80102c7d:	a1 48 17 11 80       	mov    0x80111748,%eax
...
80102c90:	8b 0c 95 4c 17 11 80 	mov    -0x7feee8b4(,%edx,4),%ecx
...
80102cca:	68 20 78 10 80       	push   $0x80107820
80102ccf:	68 00 17 11 80       	push   $0x80111700
...
80102ce8:	59                   	pop    %ecx
  log.dev = dev;
80102ce9:	89 1d 44 17 11 80    	mov    %ebx,0x80111744
  log.size = sb.nlog;
80102cef:	8b 55 e8             	mov    -0x18(%ebp),%edx
  log.start = sb.logstart;
80102cf2:	a3 34 17 11 80       	mov    %eax,0x80111734
  log.size = sb.nlog;
80102cf7:	89 15 38 17 11 80    	mov    %edx,0x80111738
  struct buf *buf = bread(log.dev, log.start);
80102cfd:	5a                   	pop    %edx
...
80102d0b:	89 1d 48 17 11 80    	mov    %ebx,0x80111748
  for (i = 0; i < log.lh.n; i++) {
...
80102d24:	89 0c 95 4c 17 11 80 	mov    %ecx,-0x7feee8b4(,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
80102d3b:	e8 80 fe ff ff       	call   80102bc0 <install_trans>
  log.lh.n = 0;
80102d40:	c7 05 48 17 11 80 00 	movl   $0x0,0x80111748
80102d47:	00 00 00 
...
80102d63:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102d66:	68 00 17 11 80       	push   $0x80111700
...
80102d7b:	68 00 17 11 80       	push   $0x80111700
80102d80:	68 00 17 11 80       	push   $0x80111700
80102d85:	e8 b6 12 00 00       	call   80104040 <sleep>
80102d8a:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102d8d:	a1 40 17 11 80       	mov    0x80111740,%eax
80102d92:	85 c0                	test   %eax,%eax
80102d94:	75 e2                	jne    80102d78 <begin_op+0x18>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102d96:	a1 3c 17 11 80       	mov    0x8011173c,%eax
80102d9b:	8b 15 48 17 11 80    	mov    0x80111748,%edx
...
80102daf:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102db2:	a3 3c 17 11 80       	mov    %eax,0x8011173c
      release(&log.lock);
80102db7:	68 00 17 11 80       	push   $0x80111700
...
80102dd6:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102dd9:	68 00 17 11 80       	push   $0x80111700
80102dde:	e8 bd 17 00 00       	call   801045a0 <acquire>
  log.outstanding -= 1;
80102de3:	a1 3c 17 11 80       	mov    0x8011173c,%eax
  if(log.committing)
80102de8:	8b 35 40 17 11 80    	mov    0x80111740,%esi
80102dee:	83 c4 10             	add    $0x10,%esp
  log.outstanding -= 1;
80102df1:	8d 58 ff             	lea    -0x1(%eax),%ebx
80102df4:	89 1d 3c 17 11 80    	mov    %ebx,0x8011173c
  if(log.committing)
...
80102e04:	0f 85 f6 00 00 00    	jne    80102f00 <end_op+0x130>
    do_commit = 1;
    log.committing = 1;
80102e0a:	c7 05 40 17 11 80 01 	movl   $0x1,0x80111740
80102e11:	00 00 00 
...
80102e17:	68 00 17 11 80       	push   $0x80111700
...
{
  if (log.lh.n > 0) {
80102e21:	8b 0d 48 17 11 80    	mov    0x80111748,%ecx
80102e27:	83 c4 10             	add    $0x10,%esp
80102e2a:	85 c9                	test   %ecx,%ecx
80102e2c:	7f 42                	jg     80102e70 <end_op+0xa0>
    acquire(&log.lock);
80102e2e:	83 ec 0c             	sub    $0xc,%esp
80102e31:	68 00 17 11 80       	push   $0x80111700
80102e36:	e8 65 17 00 00       	call   801045a0 <acquire>
    wakeup(&log);
80102e3b:	c7 04 24 00 17 11 80 	movl   $0x80111700,(%esp)
    log.committing = 0;
80102e42:	c7 05 40 17 11 80 00 	movl   $0x0,0x80111740
80102e49:	00 00 00 
    wakeup(&log);
80102e4c:	e8 af 12 00 00       	call   80104100 <wakeup>
    release(&log.lock);
80102e51:	c7 04 24 00 17 11 80 	movl   $0x80111700,(%esp)
...
80102e70:	a1 34 17 11 80       	mov    0x80111734,%eax
80102e75:	83 ec 08             	sub    $0x8,%esp
80102e78:	01 d8                	add    %ebx,%eax
80102e7a:	83 c0 01             	add    $0x1,%eax
80102e7d:	50                   	push   %eax
80102e7e:	ff 35 44 17 11 80    	push   0x80111744
80102e84:	e8 47 d2 ff ff       	call   801000d0 <bread>
80102e89:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102e8b:	58                   	pop    %eax
80102e8c:	5a                   	pop    %edx
80102e8d:	ff 34 9d 4c 17 11 80 	push   -0x7feee8b4(,%ebx,4)
80102e94:	ff 35 44 17 11 80    	push   0x80111744
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102ed4:	3b 1d 48 17 11 80    	cmp    0x80111748,%ebx
...
80102ee1:	e8 da fc ff ff       	call   80102bc0 <install_trans>
    log.lh.n = 0;
80102ee6:	c7 05 48 17 11 80 00 	movl   $0x0,0x80111748
80102eed:	00 00 00 
...
80102f03:	68 00 17 11 80       	push   $0x80111700
80102f08:	e8 f3 11 00 00       	call   80104100 <wakeup>
  release(&log.lock);
80102f0d:	c7 04 24 00 17 11 80 	movl   $0x80111700,(%esp)
...
80102f27:	68 24 78 10 80       	push   $0x80107824
...
80102f47:	8b 15 48 17 11 80    	mov    0x80111748,%edx
{
80102f4d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102f50:	83 fa 1d             	cmp    $0x1d,%edx
80102f53:	0f 8f 85 00 00 00    	jg     80102fde <log_write+0x9e>
80102f59:	a1 38 17 11 80       	mov    0x80111738,%eax
80102f5e:	83 e8 01             	sub    $0x1,%eax
80102f61:	39 c2                	cmp    %eax,%edx
80102f63:	7d 79                	jge    80102fde <log_write+0x9e>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102f65:	a1 3c 17 11 80       	mov    0x8011173c,%eax
...
80102f71:	68 00 17 11 80       	push   $0x80111700
80102f76:	e8 25 16 00 00       	call   801045a0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102f7b:	8b 15 48 17 11 80    	mov    0x80111748,%edx
...
80102f95:	74 29                	je     80102fc0 <log_write+0x80>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102f97:	39 0c 85 4c 17 11 80 	cmp    %ecx,-0x7feee8b4(,%eax,4)
80102f9e:	75 f0                	jne    80102f90 <log_write+0x50>
      break;
  }
  log.lh.block[i] = b->blockno;
80102fa0:	89 0c 85 4c 17 11 80 	mov    %ecx,-0x7feee8b4(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
...
80102faa:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  release(&log.lock);
80102fad:	c7 45 08 00 17 11 80 	movl   $0x80111700,0x8(%ebp)
}
80102fb4:	c9                   	leave  
  release(&log.lock);
...
80102fba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102fc0:	89 0c 95 4c 17 11 80 	mov    %ecx,-0x7feee8b4(,%edx,4)
    log.lh.n++;
80102fc7:	83 c2 01             	add    $0x1,%edx
80102fca:	89 15 48 17 11 80    	mov    %edx,0x80111748
80102fd0:	eb d5                	jmp    80102fa7 <log_write+0x67>
  log.lh.block[i] = b->blockno;
80102fd2:	8b 43 08             	mov    0x8(%ebx),%eax
80102fd5:	a3 4c 17 11 80       	mov    %eax,0x8011174c
  if (i == log.lh.n)
80102fda:	75 cb                	jne    80102fa7 <log_write+0x67>
80102fdc:	eb e9                	jmp    80102fc7 <log_write+0x87>
    panic("too big a transaction");
80102fde:	83 ec 0c             	sub    $0xc,%esp
80102fe1:	68 33 78 10 80       	push   $0x80107833
80102fe6:	e8 95 d3 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
80102feb:	83 ec 0c             	sub    $0xc,%esp
80102fee:	68 49 78 10 80       	push   $0x80107849
...
80103018:	68 64 78 10 80       	push   $0x80107864
8010301d:	e8 7e d6 ff ff       	call   801006a0 <cprintf>
  idtinit();       // load idt register
80103022:	e8 99 2a 00 00       	call   80105ac0 <idtinit>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 65 3b 00 00       	call   80106bb0 <switchkvm>
  seginit();
8010304b:	e8 d0 3a 00 00       	call   80106b20 <seginit>
  lapicinit();
...
80103077:	68 30 55 11 80       	push   $0x80115530
8010307c:	e8 8f f5 ff ff       	call   80102610 <kinit1>
  kvmalloc();      // kernel page table
80103081:	e8 1a 40 00 00       	call   801070a0 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 8b 3a 00 00       	call   80106b20 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 07 2d 00 00       	call   80105db0 <uartinit>
  pinit();         // process table
801030a9:	e8 22 08 00 00       	call   801038d0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 8d 29 00 00       	call   80105a40 <tvinit>
  binit();         // buffer cache
...
801030ca:	68 ec a4 10 80       	push   $0x8010a4ec
801030cf:	68 00 70 00 80       	push   $0x80007000
801030d4:	e8 27 16 00 00       	call   80104700 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
801030d9:	83 c4 10             	add    $0x10,%esp
801030dc:	69 05 e4 17 11 80 b0 	imul   $0xb0,0x801117e4,%eax
801030e3:	00 00 00 
801030e6:	05 00 18 11 80       	add    $0x80111800,%eax
801030eb:	3d 00 18 11 80       	cmp    $0x80111800,%eax
801030f0:	76 7e                	jbe    80103170 <main+0x110>
801030f2:	bb 00 18 11 80       	mov    $0x80111800,%ebx
801030f7:	eb 20                	jmp    80103119 <main+0xb9>
801030f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103100:	69 05 e4 17 11 80 b0 	imul   $0xb0,0x801117e4,%eax
80103107:	00 00 00 
8010310a:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80103110:	05 00 18 11 80       	add    $0x80111800,%eax
...
801031be:	68 78 78 10 80       	push   $0x80107878
...
80103276:	68 7d 78 10 80       	push   $0x8010787d
...
801032d6:	a3 e0 16 11 80       	mov    %eax,0x801116e0
...
80103354:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
80103357:	88 0d e0 17 11 80    	mov    %cl,0x801117e0
      continue;
8010335d:	eb 99                	jmp    801032f8 <mpinit+0xe8>
8010335f:	90                   	nop
      if(ncpu < NCPU) {
80103360:	8b 0d e4 17 11 80    	mov    0x801117e4,%ecx
...
80103378:	89 0d e4 17 11 80    	mov    %ecx,0x801117e4
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
8010337e:	88 9f 00 18 11 80    	mov    %bl,-0x7feee800(%edi)
...
80103393:	68 82 78 10 80       	push   $0x80107882
...
801033c2:	68 78 78 10 80       	push   $0x80107878
...
801033f8:	68 9c 78 10 80       	push   $0x8010789c
...
801034a0:	00 00 00 
  initlock(&p->lock, "pipe");
801034a3:	68 bb 78 10 80       	push   $0x801078bb
...
801037b4:	bb b4 1d 11 80       	mov    $0x80111db4,%ebx
{
801037b9:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
801037bc:	68 80 1d 11 80       	push   $0x80111d80
...
801037d3:	81 fb b4 3c 11 80    	cmp    $0x80113cb4,%ebx
...
801037f4:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037f7:	68 80 1d 11 80       	push   $0x80111d80
  p->pid = nextpid++;
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 2f 5a 10 80 	movl   $0x80105a2f,0x14(%eax)
  p->context = (struct context*)sp;
...
80103853:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103855:	68 80 1d 11 80       	push   $0x80111d80
...
80103883:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103886:	68 80 1d 11 80       	push   $0x80111d80
...
801038d6:	68 c0 78 10 80       	push   $0x801078c0
801038db:	68 80 1d 11 80       	push   $0x80111d80
...
801038fc:	e8 ef ef ff ff       	call   801028f0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103901:	8b 35 e4 17 11 80    	mov    0x801117e4,%esi
...
8010391d:	0f b6 99 00 18 11 80 	movzbl -0x7feee800(%ecx),%ebx
80103924:	39 c3                	cmp    %eax,%ebx
80103926:	75 e8                	jne    80103910 <mycpu+0x20>
}
80103928:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
8010392b:	8d 81 00 18 11 80    	lea    -0x7feee800(%ecx),%eax
}
80103931:	5b                   	pop    %ebx
80103932:	5e                   	pop    %esi
80103933:	5d                   	pop    %ebp
...
8010395b:	c9                   	leave  
  return mycpu()-cpus;
8010395c:	2d 00 18 11 80       	sub    $0x80111800,%eax
...
801039ac:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039ae:	a3 b4 3c 11 80       	mov    %eax,0x80113cb4
  if((p->pgdir = setupkvm()) == 0)
801039b3:	e8 68 36 00 00       	call   80107020 <setupkvm>
...
801039cb:	68 c0 a4 10 80       	push   $0x8010a4c0
801039d0:	50                   	push   %eax
801039d1:	e8 fa 32 00 00       	call   80106cd0 <inituvm>
...
80103a83:	68 d7 78 10 80       	push   $0x801078d7
...
80103abb:	e8 00 31 00 00       	call   80106bc0 <switchuvm>
  return 0;
...
80103ada:	e8 61 33 00 00       	call   80106e40 <allocuvm>
...
80103afa:	e8 71 34 00 00       	call   80106f70 <deallocuvm>
...
80103b48:	e8 c3 35 00 00       	call   80107110 <copyuvm>
...
80103bc6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bc9:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
80103bd0:	e8 cb 09 00 00       	call   801045a0 <acquire>
  np->state = RUNNABLE;
80103bd5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103bdc:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
...
80103c51:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c54:	bb b4 1d 11 80       	mov    $0x80111db4,%ebx
    acquire(&ptable.lock);
80103c59:	68 80 1d 11 80       	push   $0x80111d80
...
80103c92:	e8 e4 0b 00 00       	call   8010487b <swtch>
      switchkvm();
80103c97:	e8 14 2f 00 00       	call   80106bb0 <switchkvm>
      c->proc = 0;
...
80103cac:	81 fb b4 3c 11 80    	cmp    $0x80113cb4,%ebx
80103cb2:	75 bc                	jne    80103c70 <scheduler+0x40>
    release(&ptable.lock);
80103cb4:	83 ec 0c             	sub    $0xc,%esp
80103cb7:	68 80 1d 11 80       	push   $0x80111d80
...
80103ced:	68 80 1d 11 80       	push   $0x80111d80
...
80103d99:	e8 d2 fb ff ff       	call   80103970 <myproc>
  if(curproc == initproc)
80103d9e:	39 05 b4 3c 11 80    	cmp    %eax,0x80113cb4
...
80103dec:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103df3:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
...
80103e2f:	3d b4 3c 11 80       	cmp    $0x80113cb4,%eax
80103e34:	75 e4                	jne    80103e1a <exit+0x8a>
      p->parent = initproc;
80103e36:	8b 0d b4 3c 11 80    	mov    0x80113cb4,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e3c:	ba b4 1d 11 80       	mov    $0x80111db4,%edx
80103e41:	eb 10                	jmp    80103e53 <exit+0xc3>
80103e43:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e47:	90                   	nop
80103e48:	83 c2 7c             	add    $0x7c,%edx
80103e4b:	81 fa b4 3c 11 80    	cmp    $0x80113cb4,%edx
...
80103e9d:	68 48 79 10 80       	push   $0x80107948
80103ea2:	e8 d9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ea7:	83 ec 0c             	sub    $0xc,%esp
80103eaa:	68 3b 79 10 80       	push   $0x8010793b
...
80103f11:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f16:	81 fb b4 3c 11 80    	cmp    $0x80113cb4,%ebx
...
80103f89:	e8 12 30 00 00       	call   80106fa0 <freevm>
        p->pid = 0;
...
80103fa7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103fae:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
...
80103fc9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103fce:	68 80 1d 11 80       	push   $0x80111d80
...
80103fe0:	68 54 79 10 80       	push   $0x80107954
...
80103ff7:	68 80 1d 11 80       	push   $0x80111d80
...
8010401d:	e8 ae fc ff ff       	call   80103cd0 <sched>
  release(&ptable.lock);
80104022:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
...
80104070:	81 fe 80 1d 11 80    	cmp    $0x80111d80,%esi
80104076:	74 50                	je     801040c8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104078:	83 ec 0c             	sub    $0xc,%esp
8010407b:	68 80 1d 11 80       	push   $0x80111d80
...
8010409c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801040a3:	c7 04 24 80 1d 11 80 	movl   $0x80111d80,(%esp)
...
801040e9:	68 5a 79 10 80       	push   $0x8010795a
801040ee:	e8 8d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040f3:	83 ec 0c             	sub    $0xc,%esp
801040f6:	68 54 79 10 80       	push   $0x80107954
...
8010413f:	3d b4 3c 11 80       	cmp    $0x80113cb4,%eax
80104144:	75 e4                	jne    8010412a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80104146:	c7 45 08 80 1d 11 80 	movl   $0x80111d80,0x8(%ebp)
}
...
801041a6:	68 80 1d 11 80       	push   $0x80111d80
...
801041c3:	68 80 1d 11 80       	push   $0x80111d80
...
801041e9:	bb 20 1e 11 80       	mov    $0x80111e20,%ebx
...
8010421c:	74 ea                	je     80104208 <procdump+0x28>
      state = "???";
8010421e:	ba 6b 79 10 80       	mov    $0x8010796b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104223:	83 f8 05             	cmp    $0x5,%eax
80104226:	77 11                	ja     80104239 <procdump+0x59>
80104228:	8b 14 85 cc 79 10 80 	mov    -0x7fef8634(,%eax,4),%edx
      state = "???";
8010422f:	b8 6b 79 10 80       	mov    $0x8010796b,%eax
...
8010423e:	68 6f 79 10 80       	push   $0x8010796f
...
8010427d:	68 c1 73 10 80       	push   $0x801073c1
...
801042aa:	68 e4 79 10 80       	push   $0x801079e4
...
801044e5:	68 ef 79 10 80       	push   $0x801079ef
801044ea:	e8 91 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ef:	83 ec 0c             	sub    $0xc,%esp
801044f2:	68 06 7a 10 80       	push   $0x80107a06
...
8010455b:	68 0d 7a 10 80       	push   $0x80107a0d
...
80104650:	68 15 7a 10 80       	push   $0x80107a15
...
80104a69:	8b 55 0c             	mov    0xc(%ebp),%edx
  switch(num) {
80104a6c:	83 f8 15             	cmp    $0x15,%eax
80104a6f:	77 1f                	ja     80104a90 <print_syscall_args+0x30>
80104a71:	ff 24 85 20 7b 10 80 	jmp    *-0x7fef84e0(,%eax,4)
...
80104a7f:	90                   	nop
    ...
    case SYS_wait:
      cprintf("()");
80104a80:	c7 45 08 1d 7a 10 80 	movl   $0x80107a1d,0x8(%ebp)
      break;
...
80104a87:	c9                   	leave  
      cprintf("()");
80104a88:	e9 13 bc ff ff       	jmp    801006a0 <cprintf>
80104a8d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("(...)");
80104a90:	c7 45 08 98 7a 10 80 	movl   $0x80107a98,0x8(%ebp)
}
80104a97:	c9                   	leave  
      cprintf("(...)");
80104a98:	e9 03 bc ff ff       	jmp    801006a0 <cprintf>
80104a9d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("(fd=%d)", p->tf->ebx);
80104aa0:	8b 42 18             	mov    0x18(%edx),%eax
80104aa3:	8b 40 10             	mov    0x10(%eax),%eax
80104aa6:	c7 45 08 5b 7a 10 80 	movl   $0x80107a5b,0x8(%ebp)
80104aad:	89 45 0c             	mov    %eax,0xc(%ebp)
}
80104ab0:	c9                   	leave  
      cprintf("(fd=%d)", p->tf->ebx);
80104ab1:	e9 ea bb ff ff       	jmp    801006a0 <cprintf>
...
80104ac0:	8b 42 18             	mov    0x18(%edx),%eax
80104ac3:	83 ec 04             	sub    $0x4,%esp
80104ac6:	ff 70 14             	push   0x14(%eax)
80104ac9:	ff 70 10             	push   0x10(%eax)
80104acc:	68 35 7a 10 80       	push   $0x80107a35
...
80104ae0:	8b 42 18             	mov    0x18(%edx),%eax
80104ae3:	8b 40 10             	mov    0x10(%eax),%eax
80104ae6:	c7 45 08 20 7a 10 80 	movl   $0x80107a20,0x8(%ebp)
80104aed:	89 45 0c             	mov    %eax,0xc(%ebp)
}
80104af0:	c9                   	leave  
      cprintf("(status=%d)", p->tf->ebx);
80104af1:	e9 aa bb ff ff       	jmp    801006a0 <cprintf>
80104af6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104afd:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("(n=%d)", p->tf->ebx);
80104b00:	8b 42 18             	mov    0x18(%edx),%eax
80104b03:	8b 40 10             	mov    0x10(%eax),%eax
80104b06:	c7 45 08 6e 7a 10 80 	movl   $0x80107a6e,0x8(%ebp)
80104b0d:	89 45 0c             	mov    %eax,0xc(%ebp)
}
80104b10:	c9                   	leave  
      cprintf("(n=%d)", p->tf->ebx);
80104b11:	e9 8a bb ff ff       	jmp    801006a0 <cprintf>
80104b16:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104b1d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("(ticks=%d)", p->tf->ebx);
80104b20:	8b 42 18             	mov    0x18(%edx),%eax
80104b23:	8b 40 10             	mov    0x10(%eax),%eax
80104b26:	c7 45 08 63 7a 10 80 	movl   $0x80107a63,0x8(%ebp)
80104b2d:	89 45 0c             	mov    %eax,0xc(%ebp)
}
80104b30:	c9                   	leave  
      cprintf("(ticks=%d)", p->tf->ebx);
80104b31:	e9 6a bb ff ff       	jmp    801006a0 <cprintf>
80104b36:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104b3d:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("(path=0x%x)", p->tf->ebx);
80104b40:	8b 42 18             	mov    0x18(%edx),%eax
80104b43:	8b 40 10             	mov    0x10(%eax),%eax
80104b46:	c7 45 08 8c 7a 10 80 	movl   $0x80107a8c,0x8(%ebp)
80104b4d:	89 45 0c             	mov    %eax,0xc(%ebp)
}
80104b50:	c9                   	leave  
      cprintf("(path=0x%x)", p->tf->ebx);
80104b51:	e9 4a bb ff ff       	jmp    801006a0 <cprintf>
...
80104b60:	8b 42 18             	mov    0x18(%edx),%eax
80104b63:	83 ec 04             	sub    $0x4,%esp
80104b66:	ff 70 18             	push   0x18(%eax)
80104b69:	ff 70 10             	push   0x10(%eax)
80104b6c:	68 46 7a 10 80       	push   $0x80107a46
80104b71:	e8 2a bb ff ff       	call   801006a0 <cprintf>
      break;
...
80104b80:	8b 42 18             	mov    0x18(%edx),%eax
80104b83:	8b 40 10             	mov    0x10(%eax),%eax
80104b86:	c7 45 08 2c 7a 10 80 	movl   $0x80107a2c,0x8(%ebp)
80104b8d:	89 45 0c             	mov    %eax,0xc(%ebp)
}
80104b90:	c9                   	leave  
      cprintf("(pid=%d)", p->tf->ebx);
80104b91:	e9 0a bb ff ff       	jmp    801006a0 <cprintf>
...
80104ba0:	8b 42 18             	mov    0x18(%edx),%eax
80104ba3:	83 ec 04             	sub    $0x4,%esp
80104ba6:	ff 70 18             	push   0x18(%eax)
80104ba9:	ff 70 10             	push   0x10(%eax)
80104bac:	68 75 7a 10 80       	push   $0x80107a75
80104bb1:	e8 ea ba ff ff       	call   801006a0 <cprintf>
      break;
...
80104bc6:	83 ec 0c             	sub    $0xc,%esp
  int num;
  struct proc *curproc = myproc();
80104bc9:	e8 a2 ed ff ff       	call   80103970 <myproc>
80104bce:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104bd0:	8b 40 18             	mov    0x18(%eax),%eax
80104bd3:	8b 70 1c             	mov    0x1c(%eax),%esi
  
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104bd6:	8d 46 ff             	lea    -0x1(%esi),%eax
80104bd9:	83 f8 15             	cmp    $0x15,%eax
80104bdc:	77 62                	ja     80104c40 <syscall+0x80>
80104bde:	8b 04 b5 80 7b 10 80 	mov    -0x7fef8480(,%esi,4),%eax
80104be5:	85 c0                	test   %eax,%eax
80104be7:	74 57                	je     80104c40 <syscall+0x80>
    // Ejecutar la syscall PRIMERO
    int result = syscalls[num]();
80104be9:	ff d0                	call   *%eax
80104beb:	89 c7                	mov    %eax,%edi
    curproc->tf->eax = result;
80104bed:	8b 43 18             	mov    0x18(%ebx),%eax
80104bf0:	89 78 1c             	mov    %edi,0x1c(%eax)
    
    // Mostrar logging DESPUÉS si está activado
    // Excluir: trace, shell (sh), init
    if(syscall_tracing && 
80104bf3:	a1 b8 3c 11 80       	mov    0x80113cb8,%eax
80104bf8:	85 c0                	test   %eax,%eax
80104bfa:	74 63                	je     80104c5f <syscall+0x9f>
80104bfc:	83 fe 16             	cmp    $0x16,%esi
80104bff:	74 5e                	je     80104c5f <syscall+0x9f>
       num != SYS_trace && 
       syscall_names[num] &&
80104c01:	8b 04 b5 20 a0 10 80 	mov    -0x7fef5fe0(,%esi,4),%eax
       num != SYS_trace && 
80104c08:	85 c0                	test   %eax,%eax
80104c0a:	74 53                	je     80104c5f <syscall+0x9f>
       curproc->pid > 2) {  // Solo procesos con PID > 2
80104c0c:	8b 53 10             	mov    0x10(%ebx),%edx
       syscall_names[num] &&
80104c0f:	83 fa 02             	cmp    $0x2,%edx
80104c12:	7e 4b                	jle    80104c5f <syscall+0x9f>
      
      cprintf("[%d] %s", curproc->pid, syscall_names[num]);
80104c14:	83 ec 04             	sub    $0x4,%esp
80104c17:	50                   	push   %eax
80104c18:	52                   	push   %edx
80104c19:	68 9e 7a 10 80       	push   $0x80107a9e
80104c1e:	e8 7d ba ff ff       	call   801006a0 <cprintf>
      print_syscall_args(num, curproc);
80104c23:	58                   	pop    %eax
80104c24:	5a                   	pop    %edx
80104c25:	53                   	push   %ebx
80104c26:	56                   	push   %esi
80104c27:	e8 34 fe ff ff       	call   80104a60 <print_syscall_args>
      cprintf(" = %d\n", result);
80104c2c:	59                   	pop    %ecx
80104c2d:	5b                   	pop    %ebx
80104c2e:	57                   	push   %edi
80104c2f:	68 a6 7a 10 80       	push   $0x80107aa6
80104c34:	e8 67 ba ff ff       	call   801006a0 <cprintf>
80104c39:	83 c4 10             	add    $0x10,%esp
80104c3c:	eb 21                	jmp    80104c5f <syscall+0x9f>
80104c3e:	66 90                	xchg   %ax,%ax
    }
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            curproc->pid, curproc->name, num);
80104c40:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104c43:	56                   	push   %esi
80104c44:	50                   	push   %eax
80104c45:	ff 73 10             	push   0x10(%ebx)
80104c48:	68 ad 7a 10 80       	push   $0x80107aad
80104c4d:	e8 4e ba ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
80104c52:	8b 43 18             	mov    0x18(%ebx),%eax
80104c55:	83 c4 10             	add    $0x10,%esp
80104c58:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
80104c75:	8d 7d da             	lea    -0x26(%ebp),%edi
{
...
80104caa:	57                   	push   %edi
80104cab:	53                   	push   %ebx
80104cac:	e8 2f d0 ff ff       	call   80101ce0 <dirlookup>
80104cb1:	83 c4 10             	add    $0x10,%esp
80104cb4:	89 c6                	mov    %eax,%esi
80104cb6:	85 c0                	test   %eax,%eax
80104cb8:	74 56                	je     80104d10 <create+0xa0>
    iunlockput(dp);
80104cba:	83 ec 0c             	sub    $0xc,%esp
80104cbd:	53                   	push   %ebx
80104cbe:	e8 4d cd ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80104cc3:	89 34 24             	mov    %esi,(%esp)
80104cc6:	e8 b5 ca ff ff       	call   80101780 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104ccb:	83 c4 10             	add    $0x10,%esp
80104cce:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104cd3:	75 1b                	jne    80104cf0 <create+0x80>
80104cd5:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104cda:	75 14                	jne    80104cf0 <create+0x80>
...
80104cf3:	56                   	push   %esi
    return 0;
80104cf4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104cf6:	e8 15 cd ff ff       	call   80101a10 <iunlockput>
    return 0;
80104cfb:	83 c4 10             	add    $0x10,%esp
}
80104cfe:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104d01:	89 f0                	mov    %esi,%eax
80104d03:	5b                   	pop    %ebx
80104d04:	5e                   	pop    %esi
80104d05:	5f                   	pop    %edi
80104d06:	5d                   	pop    %ebp
...
80104d1a:	e8 f1 c8 ff ff       	call   80101610 <ialloc>
...
80104d51:	e8 7a c9 ff ff       	call   801016d0 <iupdate>
...
80104d68:	e8 73 d2 ff ff       	call   80101fe0 <dirlink>
...
80104d78:	e8 93 cc ff ff       	call   80101a10 <iunlockput>
  return ip;
...
80104d99:	e8 32 c9 ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104d9e:	83 c4 0c             	add    $0xc,%esp
80104da1:	ff 76 04             	push   0x4(%esi)
80104da4:	68 f8 7b 10 80       	push   $0x80107bf8
80104da9:	56                   	push   %esi
80104daa:	e8 31 d2 ff ff       	call   80101fe0 <dirlink>
...
80104dbc:	68 f7 7b 10 80       	push   $0x80107bf7
80104dc1:	56                   	push   %esi
80104dc2:	e8 19 d2 ff ff       	call   80101fe0 <dirlink>
...
80104dd1:	68 eb 7b 10 80       	push   $0x80107beb
...
80104de0:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80104de3:	31 f6                	xor    %esi,%esi
}
80104de5:	5b                   	pop    %ebx
80104de6:	89 f0                	mov    %esi,%eax
80104de8:	5e                   	pop    %esi
80104de9:	5f                   	pop    %edi
80104dea:	5d                   	pop    %ebp
80104deb:	c3                   	ret    
...
80104def:	68 fa 7b 10 80       	push   $0x80107bfa
80104df4:	e8 87 b5 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104df9:	83 ec 0c             	sub    $0xc,%esp
80104dfc:	68 dc 7b 10 80       	push   $0x80107bdc
80104e01:	e8 7a b5 ff ff       	call   80100380 <panic>
...
80104e1e:	e8 fd fa ff ff       	call   80104920 <argint>
80104e23:	83 c4 10             	add    $0x10,%esp
80104e26:	85 c0                	test   %eax,%eax
80104e28:	78 36                	js     80104e60 <sys_dup+0x50>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104e2a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104e2e:	77 30                	ja     80104e60 <sys_dup+0x50>
...
80104e56:	74 18                	je     80104e70 <sys_dup+0x60>
  for(fd = 0; fd < NOFILE; fd++){
80104e58:	83 c3 01             	add    $0x1,%ebx
80104e5b:	83 fb 10             	cmp    $0x10,%ebx
80104e5e:	75 f0                	jne    80104e50 <sys_dup+0x40>
}
...
80104e70:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80104e73:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
80104e77:	56                   	push   %esi
80104e78:	e8 23 c0 ff ff       	call   80100ea0 <filedup>
  return fd;
...
80104e9e:	e8 7d fa ff ff       	call   80104920 <argint>
80104ea3:	83 c4 10             	add    $0x10,%esp
80104ea6:	85 c0                	test   %eax,%eax
80104ea8:	78 5e                	js     80104f08 <sys_read+0x78>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104eaa:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104eae:	77 58                	ja     80104f08 <sys_read+0x78>
...
80104f0d:	eb ed                	jmp    80104efc <sys_read+0x6c>
80104f0f:	90                   	nop
...
80104f1e:	e8 fd f9 ff ff       	call   80104920 <argint>
80104f23:	83 c4 10             	add    $0x10,%esp
80104f26:	85 c0                	test   %eax,%eax
80104f28:	78 5e                	js     80104f88 <sys_write+0x78>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104f2a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104f2e:	77 58                	ja     80104f88 <sys_write+0x78>
...
80104f8d:	eb ed                	jmp    80104f7c <sys_write+0x6c>
80104f8f:	90                   	nop
...
80104f9e:	e8 7d f9 ff ff       	call   80104920 <argint>
80104fa3:	83 c4 10             	add    $0x10,%esp
80104fa6:	85 c0                	test   %eax,%eax
80104fa8:	78 3e                	js     80104fe8 <sys_close+0x58>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104faa:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104fae:	77 38                	ja     80104fe8 <sys_close+0x58>
80104fb0:	e8 bb e9 ff ff       	call   80103970 <myproc>
80104fb5:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104fb8:	8d 5a 08             	lea    0x8(%edx),%ebx
80104fbb:	8b 74 98 08          	mov    0x8(%eax,%ebx,4),%esi
80104fbf:	85 f6                	test   %esi,%esi
80104fc1:	74 25                	je     80104fe8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104fc3:	e8 a8 e9 ff ff       	call   80103970 <myproc>
  fileclose(f);
80104fc8:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104fcb:	c7 44 98 08 00 00 00 	movl   $0x0,0x8(%eax,%ebx,4)
80104fd2:	00 
  fileclose(f);
80104fd3:	56                   	push   %esi
80104fd4:	e8 17 bf ff ff       	call   80100ef0 <fileclose>
  return 0;
...
80104fed:	eb ef                	jmp    80104fde <sys_close+0x4e>
80104fef:	90                   	nop
...
80104ffe:	e8 1d f9 ff ff       	call   80104920 <argint>
80105003:	83 c4 10             	add    $0x10,%esp
80105006:	85 c0                	test   %eax,%eax
80105008:	78 46                	js     80105050 <sys_fstat+0x60>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
8010500a:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
8010500e:	77 40                	ja     80105050 <sys_fstat+0x60>
...
8010501e:	74 30                	je     80105050 <sys_fstat+0x60>
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
80105020:	83 ec 04             	sub    $0x4,%esp
80105023:	6a 14                	push   $0x14
80105025:	53                   	push   %ebx
80105026:	6a 01                	push   $0x1
80105028:	e8 43 f9 ff ff       	call   80104970 <argptr>
8010502d:	83 c4 10             	add    $0x10,%esp
80105030:	85 c0                	test   %eax,%eax
80105032:	78 1c                	js     80105050 <sys_fstat+0x60>
  return filestat(f, st);
80105034:	83 ec 08             	sub    $0x8,%esp
80105037:	ff 75 f4             	push   -0xc(%ebp)
8010503a:	56                   	push   %esi
8010503b:	e8 90 bf ff ff       	call   80100fd0 <filestat>
...
80105055:	eb ec                	jmp    80105043 <sys_fstat+0x53>
...
8010506f:	e8 6c f9 ff ff       	call   801049e0 <argstr>
...
801050d8:	e8 f3 c5 ff ff       	call   801016d0 <iupdate>
  iunlock(ip);
801050dd:	89 1c 24             	mov    %ebx,(%esp)
801050e0:	e8 7b c7 ff ff       	call   80101860 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
801050e5:	58                   	pop    %eax
801050e6:	5a                   	pop    %edx
801050e7:	57                   	push   %edi
801050e8:	ff 75 d0             	push   -0x30(%ebp)
801050eb:	e8 d0 cf ff ff       	call   801020c0 <nameiparent>
...
801050fd:	e8 7e c6 ff ff       	call   80101780 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105102:	8b 03                	mov    (%ebx),%eax
...
8010510e:	ff 73 04             	push   0x4(%ebx)
80105111:	57                   	push   %edi
80105112:	56                   	push   %esi
80105113:	e8 c8 ce ff ff       	call   80101fe0 <dirlink>
...
80105123:	e8 e8 c8 ff ff       	call   80101a10 <iunlockput>
  iput(ip);
80105128:	89 1c 24             	mov    %ebx,(%esp)
8010512b:	e8 80 c7 ff ff       	call   801018b0 <iput>
  end_op();
80105130:	e8 9b dc ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105158:	e8 23 c6 ff ff       	call   80101780 <ilock>
  ip->nlink--;
8010515d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105162:	89 1c 24             	mov    %ebx,(%esp)
80105165:	e8 66 c5 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
8010516a:	89 1c 24             	mov    %ebx,(%esp)
8010516d:	e8 9e c8 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105172:	e8 59 dc ff ff       	call   80102dd0 <end_op>
  return -1;
80105177:	83 c4 10             	add    $0x10,%esp
8010517a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010517f:	eb b9                	jmp    8010513a <sys_link+0xda>
    iunlockput(ip);
80105181:	83 ec 0c             	sub    $0xc,%esp
80105184:	53                   	push   %ebx
80105185:	e8 86 c8 ff ff       	call   80101a10 <iunlockput>
    end_op();
8010518a:	e8 41 dc ff ff       	call   80102dd0 <end_op>
    return -1;
8010518f:	83 c4 10             	add    $0x10,%esp
80105192:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105197:	eb a1                	jmp    8010513a <sys_link+0xda>
    end_op();
80105199:	e8 32 dc ff ff       	call   80102dd0 <end_op>
    return -1;
8010519e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801051a3:	eb 95                	jmp    8010513a <sys_link+0xda>
...
801051bf:	e8 1c f8 ff ff       	call   801049e0 <argstr>
801051c4:	83 c4 10             	add    $0x10,%esp
801051c7:	85 c0                	test   %eax,%eax
801051c9:	0f 88 7a 01 00 00    	js     80105349 <sys_unlink+0x199>
  begin_op();
801051cf:	e8 8c db ff ff       	call   80102d60 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801051d4:	8d 5d ca             	lea    -0x36(%ebp),%ebx
801051d7:	83 ec 08             	sub    $0x8,%esp
801051da:	53                   	push   %ebx
801051db:	ff 75 c0             	push   -0x40(%ebp)
801051de:	e8 dd ce ff ff       	call   801020c0 <nameiparent>
801051e3:	83 c4 10             	add    $0x10,%esp
801051e6:	89 45 b4             	mov    %eax,-0x4c(%ebp)
801051e9:	85 c0                	test   %eax,%eax
801051eb:	0f 84 62 01 00 00    	je     80105353 <sys_unlink+0x1a3>
  ilock(dp);
801051f1:	8b 7d b4             	mov    -0x4c(%ebp),%edi
...
801051fd:	58                   	pop    %eax
801051fe:	5a                   	pop    %edx
801051ff:	68 f8 7b 10 80       	push   $0x80107bf8
80105204:	53                   	push   %ebx
80105205:	e8 b6 ca ff ff       	call   80101cc0 <namecmp>
8010520a:	83 c4 10             	add    $0x10,%esp
8010520d:	85 c0                	test   %eax,%eax
8010520f:	0f 84 fb 00 00 00    	je     80105310 <sys_unlink+0x160>
80105215:	83 ec 08             	sub    $0x8,%esp
80105218:	68 f7 7b 10 80       	push   $0x80107bf7
8010521d:	53                   	push   %ebx
8010521e:	e8 9d ca ff ff       	call   80101cc0 <namecmp>
80105223:	83 c4 10             	add    $0x10,%esp
80105226:	85 c0                	test   %eax,%eax
80105228:	0f 84 e2 00 00 00    	je     80105310 <sys_unlink+0x160>
...
80105237:	e8 a4 ca ff ff       	call   80101ce0 <dirlookup>
8010523c:	83 c4 10             	add    $0x10,%esp
8010523f:	89 c3                	mov    %eax,%ebx
80105241:	85 c0                	test   %eax,%eax
80105243:	0f 84 c7 00 00 00    	je     80105310 <sys_unlink+0x160>
  ilock(ip);
...
8010525a:	0f 8e 1c 01 00 00    	jle    8010537c <sys_unlink+0x1cc>
...
80105272:	e8 e9 f3 ff ff       	call   80104660 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105277:	6a 10                	push   $0x10
80105279:	ff 75 c4             	push   -0x3c(%ebp)
8010527c:	57                   	push   %edi
8010527d:	ff 75 b4             	push   -0x4c(%ebp)
80105280:	e8 0b c9 ff ff       	call   80101b90 <writei>
80105285:	83 c4 20             	add    $0x20,%esp
80105288:	83 f8 10             	cmp    $0x10,%eax
8010528b:	0f 85 de 00 00 00    	jne    8010536f <sys_unlink+0x1bf>
  if(ip->type == T_DIR){
80105291:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105296:	0f 84 94 00 00 00    	je     80105330 <sys_unlink+0x180>
  iunlockput(dp);
8010529c:	83 ec 0c             	sub    $0xc,%esp
8010529f:	ff 75 b4             	push   -0x4c(%ebp)
801052a2:	e8 69 c7 ff ff       	call   80101a10 <iunlockput>
  ip->nlink--;
801052a7:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801052ac:	89 1c 24             	mov    %ebx,(%esp)
801052af:	e8 1c c4 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
801052b4:	89 1c 24             	mov    %ebx,(%esp)
801052b7:	e8 54 c7 ff ff       	call   80101a10 <iunlockput>
  end_op();
801052bc:	e8 0f db ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105313:	ff 75 b4             	push   -0x4c(%ebp)
80105316:	e8 f5 c6 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010531b:	e8 b0 da ff ff       	call   80102dd0 <end_op>
  return -1;
80105320:	83 c4 10             	add    $0x10,%esp
80105323:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105328:	eb 9c                	jmp    801052c6 <sys_unlink+0x116>
8010532a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    dp->nlink--;
80105330:	8b 45 b4             	mov    -0x4c(%ebp),%eax
    iupdate(dp);
80105333:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
80105336:	66 83 68 56 01       	subw   $0x1,0x56(%eax)
    iupdate(dp);
8010533b:	50                   	push   %eax
8010533c:	e8 8f c3 ff ff       	call   801016d0 <iupdate>
80105341:	83 c4 10             	add    $0x10,%esp
80105344:	e9 53 ff ff ff       	jmp    8010529c <sys_unlink+0xec>
    return -1;
80105349:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010534e:	e9 73 ff ff ff       	jmp    801052c6 <sys_unlink+0x116>
    end_op();
80105353:	e8 78 da ff ff       	call   80102dd0 <end_op>
    return -1;
80105358:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010535d:	e9 64 ff ff ff       	jmp    801052c6 <sys_unlink+0x116>
      panic("isdirempty: readi");
80105362:	83 ec 0c             	sub    $0xc,%esp
80105365:	68 1c 7c 10 80       	push   $0x80107c1c
8010536a:	e8 11 b0 ff ff       	call   80100380 <panic>
    panic("unlink: writei");
8010536f:	83 ec 0c             	sub    $0xc,%esp
80105372:	68 2e 7c 10 80       	push   $0x80107c2e
80105377:	e8 04 b0 ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
8010537c:	83 ec 0c             	sub    $0xc,%esp
8010537f:	68 0a 7c 10 80       	push   $0x80107c0a
80105384:	e8 f7 af ff ff       	call   80100380 <panic>
...
8010539f:	e8 3c f6 ff ff       	call   801049e0 <argstr>
...
801053b8:	e8 63 f5 ff ff       	call   80104920 <argint>
...
801053c2:	78 79                	js     8010543d <sys_open+0xad>
  ...
  begin_op();
801053c4:	e8 97 d9 ff ff       	call   80102d60 <begin_op>
...
801053d2:	ff 75 e0             	push   -0x20(%ebp)
801053d5:	e8 c6 cc ff ff       	call   801020a0 <namei>
...
801053eb:	e8 90 c3 ff ff       	call   80101780 <ilock>
...
80105424:	e8 c7 ba ff ff       	call   80100ef0 <fileclose>
80105429:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010542c:	83 ec 0c             	sub    $0xc,%esp
8010542f:	56                   	push   %esi
80105430:	e8 db c5 ff ff       	call   80101a10 <iunlockput>
    end_op();
80105435:	e8 96 d9 ff ff       	call   80102dd0 <end_op>
    return -1;
...
80105457:	e8 14 f8 ff ff       	call   80104c70 <create>
    if(ip == 0){
...
80105480:	e8 db c3 ff ff       	call   80101860 <iunlock>
  end_op();
80105485:	e8 46 d9 ff ff       	call   80102dd0 <end_op>
...
801054ff:	e8 6c f7 ff ff       	call   80104c70 <create>
...
8010550f:	e8 fc c4 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105514:	e8 b7 d8 ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105544:	e8 97 f4 ff ff       	call   801049e0 <argstr>
...
80105559:	e8 c2 f3 ff ff       	call   80104920 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010556e:	e8 ad f3 ff ff       	call   80104920 <argint>
     argint(1, &major) < 0 ||
...
8010558e:	e8 dd f6 ff ff       	call   80104c70 <create>
     argint(2, &minor) < 0 ||
...
8010559e:	e8 6d c4 ff ff       	call   80101a10 <iunlockput>
  end_op();
801055a3:	e8 28 d8 ff ff       	call   80102dd0 <end_op>
  return 0;
...
801055ec:	ff 75 f4             	push   -0xc(%ebp)
801055ef:	e8 ac ca ff ff       	call   801020a0 <namei>
...
80105601:	e8 7a c1 ff ff       	call   80101780 <ilock>
  if(ip->type != T_DIR){
...
80105614:	e8 47 c2 ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
80105619:	58                   	pop    %eax
8010561a:	ff 76 68             	push   0x68(%esi)
8010561d:	e8 8e c2 ff ff       	call   801018b0 <iput>
  end_op();
...
80105685:	e8 56 f3 ff ff       	call   801049e0 <argstr>
...
801056a1:	e8 7a f2 ff ff       	call   80104920 <argint>
...
801056b0:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
  for(i=0;; i++){
...
801056c0:	e8 9b ef ff ff       	call   80104660 <memset>
...
801056d3:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
801056d9:	8d 3c 9d 00 00 00 00 	lea    0x0(,%ebx,4),%edi
801056e0:	50                   	push   %eax
801056e1:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
801056e7:	01 f8                	add    %edi,%eax
801056e9:	50                   	push   %eax
801056ea:	e8 a1 f1 ff ff       	call   80104890 <fetchint>
801056ef:	83 c4 10             	add    $0x10,%esp
801056f2:	85 c0                	test   %eax,%eax
801056f4:	78 26                	js     8010571c <sys_exec+0xac>
      return -1;
    if(uarg == 0){
801056f6:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
801056fc:	85 c0                	test   %eax,%eax
801056fe:	74 30                	je     80105730 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80105700:	83 ec 08             	sub    $0x8,%esp
80105703:	8d 14 3e             	lea    (%esi,%edi,1),%edx
80105706:	52                   	push   %edx
80105707:	50                   	push   %eax
80105708:	e8 c3 f1 ff ff       	call   801048d0 <fetchstr>
...
80105729:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      argv[i] = 0;
80105730:	c7 84 9d 68 ff ff ff 	movl   $0x0,-0x98(%ebp,%ebx,4)
80105737:	00 00 00 00 
  return exec(path, argv);
8010573b:	83 ec 08             	sub    $0x8,%esp
8010573e:	56                   	push   %esi
8010573f:	ff b5 5c ff ff ff    	push   -0xa4(%ebp)
80105745:	e8 66 b3 ff ff       	call   80100ab0 <exec>
...
80105771:	e8 fa f1 ff ff       	call   80104970 <argptr>
...
80105788:	e8 a3 dc ff ff       	call   80103430 <pipealloc>
...
80105797:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105799:	e8 d2 e1 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801057b3:	ff 75 e0             	push   -0x20(%ebp)
801057b6:	e8 35 b7 ff ff       	call   80100ef0 <fileclose>
    fileclose(wf);
801057bb:	58                   	pop    %eax
801057bc:	ff 75 e4             	push   -0x1c(%ebp)
801057bf:	e8 2c b7 ff ff       	call   80100ef0 <fileclose>
    return -1;
...
801057f6:	75 f0                	jne    801057e8 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
801057f8:	e8 73 e1 ff ff       	call   80103970 <myproc>
...
{
  return fork();
80105830:	e9 db e2 ff ff       	jmp    80103b10 <fork>
...
80105843:	83 ec 08             	sub    $0x8,%esp
  exit();
80105846:	e8 45 e5 ff ff       	call   80103d90 <exit>
...
{
  return wait();
80105850:	e9 6b e6 ff ff       	jmp    80103ec0 <wait>
...
8010586c:	e8 af f0 ff ff       	call   80104920 <argint>
...
8010587e:	e8 dd e8 ff ff       	call   80104160 <kill>
...
801058a3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801058a6:	e8 c5 e0 ff ff       	call   80103970 <myproc>
...
801058d6:	e8 b5 e1 ff ff       	call   80103a90 <growproc>
...
8010590d:	e8 0e f0 ff ff       	call   80104920 <argint>
...
80105920:	68 e0 3c 11 80       	push   $0x80113ce0
80105925:	e8 76 ec ff ff       	call   801045a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010592a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010592d:	8b 1d c0 3c 11 80    	mov    0x80113cc0,%ebx
  while(ticks - ticks0 < n){
...
80105943:	68 e0 3c 11 80       	push   $0x80113ce0
80105948:	68 c0 3c 11 80       	push   $0x80113cc0
8010594d:	e8 ee e6 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
80105952:	a1 c0 3c 11 80       	mov    0x80113cc0,%eax
...
8010595f:	73 2f                	jae    80105990 <sys_sleep+0x90>
    if(myproc()->killed){
80105961:	e8 0a e0 ff ff       	call   80103970 <myproc>
...
80105970:	68 e0 3c 11 80       	push   $0x80113ce0
80105975:	e8 c6 eb ff ff       	call   80104540 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105993:	68 e0 3c 11 80       	push   $0x80113ce0
80105998:	e8 a3 eb ff ff       	call   80104540 <release>
  return 0;
...
801059b4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059b7:	68 e0 3c 11 80       	push   $0x80113ce0
801059bc:	e8 df eb ff ff       	call   801045a0 <acquire>
  xticks = ticks;
801059c1:	8b 1d c0 3c 11 80    	mov    0x80113cc0,%ebx
  release(&tickslock);
801059c7:	c7 04 24 e0 3c 11 80 	movl   $0x80113ce0,(%esp)
801059ce:	e8 6d eb ff ff       	call   80104540 <release>
  return xticks;
}
...
801059ec:	e8 2f ef ff ff       	call   80104920 <argint>
801059f1:	83 c4 10             	add    $0x10,%esp
801059f4:	85 c0                	test   %eax,%eax
801059f6:	78 18                	js     80105a10 <sys_trace+0x30>
    return -1;

  // Validar que sea 0 o 1
  if(n != 0 && n != 1) {
801059f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059fb:	83 f8 01             	cmp    $0x1,%eax
801059fe:	77 10                	ja     80105a10 <sys_trace+0x30>
    return -1;
  }
  // Activar/desactivar tracing
  syscall_tracing = n;
80105a00:	a3 b8 3c 11 80       	mov    %eax,0x80113cb8
  return 0;
...
80105a18:	06                   	push   %es
  pushl %fs
80105a19:	0f a0                	push   %fs
  pushl %gs
80105a1b:	0f a8                	push   %gs
  pushal
80105a1d:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105a1e:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105a22:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105a24:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105a26:	54                   	push   %esp
  call trap
80105a27:	e8 c4 00 00 00       	call   80105af0 <trap>
  addl $4, %esp
80105a2c:	83 c4 04             	add    $0x4,%esp
...
80105a2f:	61                   	popa   
  popl %gs
80105a30:	0f a9                	pop    %gs
  popl %fs
80105a32:	0f a1                	pop    %fs
  popl %es
80105a34:	07                   	pop    %es
  popl %ds
80105a35:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105a36:	83 c4 08             	add    $0x8,%esp
  iret
80105a39:	cf                   	iret   
...
80105a50:	8b 14 85 7c a0 10 80 	mov    -0x7fef5f84(,%eax,4),%edx
80105a57:	c7 04 c5 22 3d 11 80 	movl   $0x8e000008,-0x7feec2de(,%eax,8)
80105a5e:	08 00 00 8e 
80105a62:	66 89 14 c5 20 3d 11 	mov    %dx,-0x7feec2e0(,%eax,8)
80105a69:	80 
80105a6a:	c1 ea 10             	shr    $0x10,%edx
80105a6d:	66 89 14 c5 26 3d 11 	mov    %dx,-0x7feec2da(,%eax,8)
80105a74:	80 
  for(i = 0; i < 256; i++)
...
80105a7f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a82:	a1 7c a1 10 80       	mov    0x8010a17c,%eax
80105a87:	c7 05 22 3f 11 80 08 	movl   $0xef000008,0x80113f22
80105a8e:	00 00 ef 
  initlock(&tickslock, "time");
80105a91:	68 fc 7a 10 80       	push   $0x80107afc
80105a96:	68 e0 3c 11 80       	push   $0x80113ce0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a9b:	66 a3 20 3f 11 80    	mov    %ax,0x80113f20
80105aa1:	c1 e8 10             	shr    $0x10,%eax
80105aa4:	66 a3 26 3f 11 80    	mov    %ax,0x80113f26
  initlock(&tickslock, "time");
80105aaa:	e8 21 e9 ff ff       	call   801043d0 <initlock>
}
...
80105acb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105acf:	b8 20 3d 11 80       	mov    $0x80113d20,%eax
...
80105b02:	0f 84 68 01 00 00    	je     80105c70 <trap+0x180>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105b14:	ff 24 85 e0 7c 10 80 	jmp    *-0x7fef8320(,%eax,4)
...
80105b1f:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105b20:	e8 1b c7 ff ff       	call   80102240 <ideintr>
    lapiceoi();
...
80105b31:	74 1d                	je     80105b50 <trap+0x60>
80105b33:	e8 38 de ff ff       	call   80103970 <myproc>
80105b38:	8b 50 24             	mov    0x24(%eax),%edx
80105b3b:	85 d2                	test   %edx,%edx
80105b3d:	74 11                	je     80105b50 <trap+0x60>
80105b3f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105b43:	83 e0 03             	and    $0x3,%eax
80105b46:	66 83 f8 03          	cmp    $0x3,%ax
80105b4a:	0f 84 e8 01 00 00    	je     80105d38 <trap+0x248>
    exit();
...
80105b57:	74 0f                	je     80105b68 <trap+0x78>
80105b59:	e8 12 de ff ff       	call   80103970 <myproc>
80105b5e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105b62:	0f 84 b8 00 00 00    	je     80105c20 <trap+0x130>
...
80105b6f:	74 1d                	je     80105b8e <trap+0x9e>
80105b71:	e8 fa dd ff ff       	call   80103970 <myproc>
80105b76:	8b 40 24             	mov    0x24(%eax),%eax
80105b79:	85 c0                	test   %eax,%eax
80105b7b:	74 11                	je     80105b8e <trap+0x9e>
80105b7d:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105b81:	83 e0 03             	and    $0x3,%eax
80105b84:	66 83 f8 03          	cmp    $0x3,%ax
80105b88:	0f 84 0f 01 00 00    	je     80105c9d <trap+0x1ad>
    exit();
}
80105b8e:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105b91:	5b                   	pop    %ebx
80105b92:	5e                   	pop    %esi
80105b93:	5f                   	pop    %edi
80105b94:	5d                   	pop    %ebp
...
80105ba0:	e8 cb dd ff ff       	call   80103970 <myproc>
80105ba5:	8b 7b 38             	mov    0x38(%ebx),%edi
80105ba8:	85 c0                	test   %eax,%eax
80105baa:	0f 84 a2 01 00 00    	je     80105d52 <trap+0x262>
80105bb0:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105bb4:	0f 84 98 01 00 00    	je     80105d52 <trap+0x262>
...
80105bc0:	e8 8b dd ff ff       	call   80103950 <cpuid>
...
80105bd1:	e8 9a dd ff ff       	call   80103970 <myproc>
80105bd6:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105bd9:	e8 92 dd ff ff       	call   80103970 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105bde:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105be1:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105be4:	51                   	push   %ecx
80105be5:	57                   	push   %edi
...
80105bf5:	68 9c 7c 10 80       	push   $0x80107c9c
80105bfa:	e8 a1 aa ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105bff:	83 c4 20             	add    $0x20,%esp
80105c02:	e8 69 dd ff ff       	call   80103970 <myproc>
80105c07:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c0e:	e8 5d dd ff ff       	call   80103970 <myproc>
80105c13:	85 c0                	test   %eax,%eax
80105c15:	0f 85 18 ff ff ff    	jne    80105b33 <trap+0x43>
80105c1b:	e9 30 ff ff ff       	jmp    80105b50 <trap+0x60>
  if(myproc() && myproc()->state == RUNNING &&
80105c20:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105c24:	0f 85 3e ff ff ff    	jne    80105b68 <trap+0x78>
    yield();
80105c2a:	e8 c1 e3 ff ff       	call   80103ff0 <yield>
80105c2f:	e9 34 ff ff ff       	jmp    80105b68 <trap+0x78>
80105c34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105c38:	8b 7b 38             	mov    0x38(%ebx),%edi
80105c3b:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105c3f:	e8 0c dd ff ff       	call   80103950 <cpuid>
80105c44:	57                   	push   %edi
80105c45:	56                   	push   %esi
80105c46:	50                   	push   %eax
80105c47:	68 44 7c 10 80       	push   $0x80107c44
80105c4c:	e8 4f aa ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105c51:	e8 ba cc ff ff       	call   80102910 <lapiceoi>
    break;
80105c56:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c59:	e8 12 dd ff ff       	call   80103970 <myproc>
80105c5e:	85 c0                	test   %eax,%eax
80105c60:	0f 85 cd fe ff ff    	jne    80105b33 <trap+0x43>
80105c66:	e9 e5 fe ff ff       	jmp    80105b50 <trap+0x60>
80105c6b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105c6f:	90                   	nop
    if(myproc()->killed)
80105c70:	e8 fb dc ff ff       	call   80103970 <myproc>
80105c75:	8b 70 24             	mov    0x24(%eax),%esi
80105c78:	85 f6                	test   %esi,%esi
80105c7a:	0f 85 c8 00 00 00    	jne    80105d48 <trap+0x258>
    myproc()->tf = tf;
80105c80:	e8 eb dc ff ff       	call   80103970 <myproc>
80105c85:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c88:	e8 33 ef ff ff       	call   80104bc0 <syscall>
    if(myproc()->killed)
80105c8d:	e8 de dc ff ff       	call   80103970 <myproc>
80105c92:	8b 48 24             	mov    0x24(%eax),%ecx
80105c95:	85 c9                	test   %ecx,%ecx
80105c97:	0f 84 f1 fe ff ff    	je     80105b8e <trap+0x9e>
}
80105c9d:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105ca0:	5b                   	pop    %ebx
80105ca1:	5e                   	pop    %esi
80105ca2:	5f                   	pop    %edi
80105ca3:	5d                   	pop    %ebp
      exit();
80105ca4:	e9 e7 e0 ff ff       	jmp    80103d90 <exit>
80105ca9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105cb0:	e8 3b 02 00 00       	call   80105ef0 <uartintr>
    lapiceoi();
80105cb5:	e8 56 cc ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cba:	e8 b1 dc ff ff       	call   80103970 <myproc>
80105cbf:	85 c0                	test   %eax,%eax
80105cc1:	0f 85 6c fe ff ff    	jne    80105b33 <trap+0x43>
80105cc7:	e9 84 fe ff ff       	jmp    80105b50 <trap+0x60>
80105ccc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105cd0:	e8 fb ca ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80105cd5:	e8 36 cc ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cda:	e8 91 dc ff ff       	call   80103970 <myproc>
80105cdf:	85 c0                	test   %eax,%eax
80105ce1:	0f 85 4c fe ff ff    	jne    80105b33 <trap+0x43>
80105ce7:	e9 64 fe ff ff       	jmp    80105b50 <trap+0x60>
80105cec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105cf0:	e8 5b dc ff ff       	call   80103950 <cpuid>
80105cf5:	85 c0                	test   %eax,%eax
80105cf7:	0f 85 28 fe ff ff    	jne    80105b25 <trap+0x35>
      acquire(&tickslock);
80105cfd:	83 ec 0c             	sub    $0xc,%esp
80105d00:	68 e0 3c 11 80       	push   $0x80113ce0
80105d05:	e8 96 e8 ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105d0a:	c7 04 24 c0 3c 11 80 	movl   $0x80113cc0,(%esp)
      ticks++;
80105d11:	83 05 c0 3c 11 80 01 	addl   $0x1,0x80113cc0
      wakeup(&ticks);
80105d18:	e8 e3 e3 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105d1d:	c7 04 24 e0 3c 11 80 	movl   $0x80113ce0,(%esp)
80105d24:	e8 17 e8 ff ff       	call   80104540 <release>
80105d29:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105d2c:	e9 f4 fd ff ff       	jmp    80105b25 <trap+0x35>
80105d31:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105d38:	e8 53 e0 ff ff       	call   80103d90 <exit>
80105d3d:	e9 0e fe ff ff       	jmp    80105b50 <trap+0x60>
80105d42:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105d48:	e8 43 e0 ff ff       	call   80103d90 <exit>
80105d4d:	e9 2e ff ff ff       	jmp    80105c80 <trap+0x190>
80105d52:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d55:	e8 f6 db ff ff       	call   80103950 <cpuid>
80105d5a:	83 ec 0c             	sub    $0xc,%esp
80105d5d:	56                   	push   %esi
80105d5e:	57                   	push   %edi
80105d5f:	50                   	push   %eax
80105d60:	ff 73 30             	push   0x30(%ebx)
80105d63:	68 68 7c 10 80       	push   $0x80107c68
80105d68:	e8 33 a9 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105d6d:	83 c4 14             	add    $0x14,%esp
80105d70:	68 3d 7c 10 80       	push   $0x80107c3d
80105d75:	e8 06 a6 ff ff       	call   80100380 <panic>
...
{
  if(!uart)
80105d80:	a1 20 45 11 80       	mov    0x80114520,%eax
...
80105dc5:	be fb 03 00 00       	mov    $0x3fb,%esi
...
80105ddd:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80105de2:	89 c8                	mov    %ecx,%eax
80105de4:	89 da                	mov    %ebx,%edx
...
80105e07:	74 78                	je     80105e81 <uartinit+0xd1>
  uart = 1;
80105e09:	c7 05 20 45 11 80 01 	movl   $0x1,0x80114520
80105e10:	00 00 00 
...
80105e1c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e1f:	bf 60 7d 10 80       	mov    $0x80107d60,%edi
80105e24:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105e29:	6a 00                	push   $0x0
80105e2b:	6a 04                	push   $0x4
80105e2d:	e8 4e c6 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105e32:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
80105e36:	83 c4 10             	add    $0x10,%esp
80105e39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105e40:	a1 20 45 11 80       	mov    0x80114520,%eax
80105e45:	bb 80 00 00 00       	mov    $0x80,%ebx
80105e4a:	85 c0                	test   %eax,%eax
80105e4c:	75 14                	jne    80105e62 <uartinit+0xb2>
80105e4e:	eb 23                	jmp    80105e73 <uartinit+0xc3>
    microdelay(10);
...
80105e60:	74 07                	je     80105e69 <uartinit+0xb9>
80105e62:	89 f2                	mov    %esi,%edx
80105e64:	ec                   	in     (%dx),%al
80105e65:	a8 20                	test   $0x20,%al
80105e67:	74 e7                	je     80105e50 <uartinit+0xa0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105e69:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105e6d:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105e72:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105e73:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105e77:	83 c7 01             	add    $0x1,%edi
80105e7a:	88 45 e7             	mov    %al,-0x19(%ebp)
80105e7d:	84 c0                	test   %al,%al
80105e7f:	75 bf                	jne    80105e40 <uartinit+0x90>
}
...
80105e90 <uartputc>:
  if(!uart)
80105e90:	a1 20 45 11 80       	mov    0x80114520,%eax
80105e95:	85 c0                	test   %eax,%eax
80105e97:	74 47                	je     80105ee0 <uartputc+0x50>
{
...
80105ea3:	bb 80 00 00 00       	mov    $0x80,%ebx
80105ea8:	eb 18                	jmp    80105ec2 <uartputc+0x32>
...
80105ec0:	74 07                	je     80105ec9 <uartputc+0x39>
80105ec2:	89 f2                	mov    %esi,%edx
80105ec4:	ec                   	in     (%dx),%al
80105ec5:	a8 20                	test   $0x20,%al
80105ec7:	74 e7                	je     80105eb0 <uartputc+0x20>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105ec9:	8b 45 08             	mov    0x8(%ebp),%eax
80105ecc:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105ed1:	ee                   	out    %al,(%dx)
}
80105ed2:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105ed5:	5b                   	pop    %ebx
80105ed6:	5e                   	pop    %esi
80105ed7:	5d                   	pop    %ebp
80105ed8:	c3                   	ret    
...
80105efb:	e8 80 a9 ff ff       	call   80100880 <consoleintr>
}
...
80105f07:	6a 00                	push   $0x0
  jmp alltraps
80105f09:	e9 09 fb ff ff       	jmp    80105a17 <alltraps>
...
80105f10:	6a 01                	push   $0x1
  jmp alltraps
80105f12:	e9 00 fb ff ff       	jmp    80105a17 <alltraps>
...
80105f19:	6a 02                	push   $0x2
  jmp alltraps
80105f1b:	e9 f7 fa ff ff       	jmp    80105a17 <alltraps>
...
80105f22:	6a 03                	push   $0x3
  jmp alltraps
80105f24:	e9 ee fa ff ff       	jmp    80105a17 <alltraps>
...
80105f2b:	6a 04                	push   $0x4
  jmp alltraps
80105f2d:	e9 e5 fa ff ff       	jmp    80105a17 <alltraps>
...
80105f34:	6a 05                	push   $0x5
  jmp alltraps
80105f36:	e9 dc fa ff ff       	jmp    80105a17 <alltraps>
...
80105f3d:	6a 06                	push   $0x6
  jmp alltraps
80105f3f:	e9 d3 fa ff ff       	jmp    80105a17 <alltraps>
...
80105f46:	6a 07                	push   $0x7
  jmp alltraps
80105f48:	e9 ca fa ff ff       	jmp    80105a17 <alltraps>
...
80105f4d:	6a 08                	push   $0x8
  jmp alltraps
80105f4f:	e9 c3 fa ff ff       	jmp    80105a17 <alltraps>
...
80105f56:	6a 09                	push   $0x9
  jmp alltraps
80105f58:	e9 ba fa ff ff       	jmp    80105a17 <alltraps>
...
80105f5d:	6a 0a                	push   $0xa
  jmp alltraps
80105f5f:	e9 b3 fa ff ff       	jmp    80105a17 <alltraps>
...
80105f64:	6a 0b                	push   $0xb
  jmp alltraps
80105f66:	e9 ac fa ff ff       	jmp    80105a17 <alltraps>
...
80105f6b:	6a 0c                	push   $0xc
  jmp alltraps
80105f6d:	e9 a5 fa ff ff       	jmp    80105a17 <alltraps>
...
80105f72:	6a 0d                	push   $0xd
  jmp alltraps
80105f74:	e9 9e fa ff ff       	jmp    80105a17 <alltraps>
...
80105f79:	6a 0e                	push   $0xe
  jmp alltraps
80105f7b:	e9 97 fa ff ff       	jmp    80105a17 <alltraps>
...
80105f82:	6a 0f                	push   $0xf
  jmp alltraps
80105f84:	e9 8e fa ff ff       	jmp    80105a17 <alltraps>
...
80105f8b:	6a 10                	push   $0x10
  jmp alltraps
80105f8d:	e9 85 fa ff ff       	jmp    80105a17 <alltraps>
...
80105f92:	6a 11                	push   $0x11
  jmp alltraps
80105f94:	e9 7e fa ff ff       	jmp    80105a17 <alltraps>
...
80105f9b:	6a 12                	push   $0x12
  jmp alltraps
80105f9d:	e9 75 fa ff ff       	jmp    80105a17 <alltraps>
...
80105fa4:	6a 13                	push   $0x13
  jmp alltraps
80105fa6:	e9 6c fa ff ff       	jmp    80105a17 <alltraps>
...
80105fad:	6a 14                	push   $0x14
  jmp alltraps
80105faf:	e9 63 fa ff ff       	jmp    80105a17 <alltraps>
...
80105fb6:	6a 15                	push   $0x15
  jmp alltraps
80105fb8:	e9 5a fa ff ff       	jmp    80105a17 <alltraps>
...
80105fbf:	6a 16                	push   $0x16
  jmp alltraps
80105fc1:	e9 51 fa ff ff       	jmp    80105a17 <alltraps>
...
80105fc8:	6a 17                	push   $0x17
  jmp alltraps
80105fca:	e9 48 fa ff ff       	jmp    80105a17 <alltraps>
...
80105fd1:	6a 18                	push   $0x18
  jmp alltraps
80105fd3:	e9 3f fa ff ff       	jmp    80105a17 <alltraps>
...
80105fda:	6a 19                	push   $0x19
  jmp alltraps
80105fdc:	e9 36 fa ff ff       	jmp    80105a17 <alltraps>
...
80105fe3:	6a 1a                	push   $0x1a
  jmp alltraps
80105fe5:	e9 2d fa ff ff       	jmp    80105a17 <alltraps>
...
80105fec:	6a 1b                	push   $0x1b
  jmp alltraps
80105fee:	e9 24 fa ff ff       	jmp    80105a17 <alltraps>
...
80105ff5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ff7:	e9 1b fa ff ff       	jmp    80105a17 <alltraps>
...
80105ffe:	6a 1d                	push   $0x1d
  jmp alltraps
80106000:	e9 12 fa ff ff       	jmp    80105a17 <alltraps>
...
80106007:	6a 1e                	push   $0x1e
  jmp alltraps
80106009:	e9 09 fa ff ff       	jmp    80105a17 <alltraps>
...
80106010:	6a 1f                	push   $0x1f
  jmp alltraps
80106012:	e9 00 fa ff ff       	jmp    80105a17 <alltraps>
...
80106019:	6a 20                	push   $0x20
  jmp alltraps
8010601b:	e9 f7 f9 ff ff       	jmp    80105a17 <alltraps>
...
80106022:	6a 21                	push   $0x21
  jmp alltraps
80106024:	e9 ee f9 ff ff       	jmp    80105a17 <alltraps>
...
8010602b:	6a 22                	push   $0x22
  jmp alltraps
8010602d:	e9 e5 f9 ff ff       	jmp    80105a17 <alltraps>
...
80106034:	6a 23                	push   $0x23
  jmp alltraps
80106036:	e9 dc f9 ff ff       	jmp    80105a17 <alltraps>
...
8010603d:	6a 24                	push   $0x24
  jmp alltraps
8010603f:	e9 d3 f9 ff ff       	jmp    80105a17 <alltraps>
...
80106046:	6a 25                	push   $0x25
  jmp alltraps
80106048:	e9 ca f9 ff ff       	jmp    80105a17 <alltraps>
...
8010604f:	6a 26                	push   $0x26
  jmp alltraps
80106051:	e9 c1 f9 ff ff       	jmp    80105a17 <alltraps>
...
80106058:	6a 27                	push   $0x27
  jmp alltraps
8010605a:	e9 b8 f9 ff ff       	jmp    80105a17 <alltraps>
...
80106061:	6a 28                	push   $0x28
  jmp alltraps
80106063:	e9 af f9 ff ff       	jmp    80105a17 <alltraps>
...
8010606a:	6a 29                	push   $0x29
  jmp alltraps
8010606c:	e9 a6 f9 ff ff       	jmp    80105a17 <alltraps>
...
80106073:	6a 2a                	push   $0x2a
  jmp alltraps
80106075:	e9 9d f9 ff ff       	jmp    80105a17 <alltraps>
...
8010607c:	6a 2b                	push   $0x2b
  jmp alltraps
8010607e:	e9 94 f9 ff ff       	jmp    80105a17 <alltraps>
...
80106085:	6a 2c                	push   $0x2c
  jmp alltraps
80106087:	e9 8b f9 ff ff       	jmp    80105a17 <alltraps>
...
8010608e:	6a 2d                	push   $0x2d
  jmp alltraps
80106090:	e9 82 f9 ff ff       	jmp    80105a17 <alltraps>
...
80106097:	6a 2e                	push   $0x2e
  jmp alltraps
80106099:	e9 79 f9 ff ff       	jmp    80105a17 <alltraps>
...
801060a0:	6a 2f                	push   $0x2f
  jmp alltraps
801060a2:	e9 70 f9 ff ff       	jmp    80105a17 <alltraps>
...
801060a9:	6a 30                	push   $0x30
  jmp alltraps
801060ab:	e9 67 f9 ff ff       	jmp    80105a17 <alltraps>
...
801060b2:	6a 31                	push   $0x31
  jmp alltraps
801060b4:	e9 5e f9 ff ff       	jmp    80105a17 <alltraps>
...
801060bb:	6a 32                	push   $0x32
  jmp alltraps
801060bd:	e9 55 f9 ff ff       	jmp    80105a17 <alltraps>
...
801060c4:	6a 33                	push   $0x33
  jmp alltraps
801060c6:	e9 4c f9 ff ff       	jmp    80105a17 <alltraps>
...
801060cd:	6a 34                	push   $0x34
  jmp alltraps
801060cf:	e9 43 f9 ff ff       	jmp    80105a17 <alltraps>
...
801060d6:	6a 35                	push   $0x35
  jmp alltraps
801060d8:	e9 3a f9 ff ff       	jmp    80105a17 <alltraps>
...
801060df:	6a 36                	push   $0x36
  jmp alltraps
801060e1:	e9 31 f9 ff ff       	jmp    80105a17 <alltraps>
...
801060e8:	6a 37                	push   $0x37
  jmp alltraps
801060ea:	e9 28 f9 ff ff       	jmp    80105a17 <alltraps>
...
801060f1:	6a 38                	push   $0x38
  jmp alltraps
801060f3:	e9 1f f9 ff ff       	jmp    80105a17 <alltraps>
...
801060fa:	6a 39                	push   $0x39
  jmp alltraps
801060fc:	e9 16 f9 ff ff       	jmp    80105a17 <alltraps>
...
80106103:	6a 3a                	push   $0x3a
  jmp alltraps
80106105:	e9 0d f9 ff ff       	jmp    80105a17 <alltraps>
...
8010610c:	6a 3b                	push   $0x3b
  jmp alltraps
8010610e:	e9 04 f9 ff ff       	jmp    80105a17 <alltraps>
...
80106115:	6a 3c                	push   $0x3c
  jmp alltraps
80106117:	e9 fb f8 ff ff       	jmp    80105a17 <alltraps>
...
8010611e:	6a 3d                	push   $0x3d
  jmp alltraps
80106120:	e9 f2 f8 ff ff       	jmp    80105a17 <alltraps>
...
80106127:	6a 3e                	push   $0x3e
  jmp alltraps
80106129:	e9 e9 f8 ff ff       	jmp    80105a17 <alltraps>
...
80106130:	6a 3f                	push   $0x3f
  jmp alltraps
80106132:	e9 e0 f8 ff ff       	jmp    80105a17 <alltraps>
...
80106139:	6a 40                	push   $0x40
  jmp alltraps
8010613b:	e9 d7 f8 ff ff       	jmp    80105a17 <alltraps>
...
80106142:	6a 41                	push   $0x41
  jmp alltraps
80106144:	e9 ce f8 ff ff       	jmp    80105a17 <alltraps>
...
8010614b:	6a 42                	push   $0x42
  jmp alltraps
8010614d:	e9 c5 f8 ff ff       	jmp    80105a17 <alltraps>
...
80106154:	6a 43                	push   $0x43
  jmp alltraps
80106156:	e9 bc f8 ff ff       	jmp    80105a17 <alltraps>
...
8010615d:	6a 44                	push   $0x44
  jmp alltraps
8010615f:	e9 b3 f8 ff ff       	jmp    80105a17 <alltraps>
...
80106166:	6a 45                	push   $0x45
  jmp alltraps
80106168:	e9 aa f8 ff ff       	jmp    80105a17 <alltraps>
...
8010616f:	6a 46                	push   $0x46
  jmp alltraps
80106171:	e9 a1 f8 ff ff       	jmp    80105a17 <alltraps>
...
80106178:	6a 47                	push   $0x47
  jmp alltraps
8010617a:	e9 98 f8 ff ff       	jmp    80105a17 <alltraps>
...
80106181:	6a 48                	push   $0x48
  jmp alltraps
80106183:	e9 8f f8 ff ff       	jmp    80105a17 <alltraps>
...
8010618a:	6a 49                	push   $0x49
  jmp alltraps
8010618c:	e9 86 f8 ff ff       	jmp    80105a17 <alltraps>
...
80106193:	6a 4a                	push   $0x4a
  jmp alltraps
80106195:	e9 7d f8 ff ff       	jmp    80105a17 <alltraps>
...
8010619c:	6a 4b                	push   $0x4b
  jmp alltraps
8010619e:	e9 74 f8 ff ff       	jmp    80105a17 <alltraps>
...
801061a5:	6a 4c                	push   $0x4c
  jmp alltraps
801061a7:	e9 6b f8 ff ff       	jmp    80105a17 <alltraps>
...
801061ae:	6a 4d                	push   $0x4d
  jmp alltraps
801061b0:	e9 62 f8 ff ff       	jmp    80105a17 <alltraps>
...
801061b7:	6a 4e                	push   $0x4e
  jmp alltraps
801061b9:	e9 59 f8 ff ff       	jmp    80105a17 <alltraps>
...
801061c0:	6a 4f                	push   $0x4f
  jmp alltraps
801061c2:	e9 50 f8 ff ff       	jmp    80105a17 <alltraps>
...
801061c9:	6a 50                	push   $0x50
  jmp alltraps
801061cb:	e9 47 f8 ff ff       	jmp    80105a17 <alltraps>
...
801061d2:	6a 51                	push   $0x51
  jmp alltraps
801061d4:	e9 3e f8 ff ff       	jmp    80105a17 <alltraps>
...
801061db:	6a 52                	push   $0x52
  jmp alltraps
801061dd:	e9 35 f8 ff ff       	jmp    80105a17 <alltraps>
...
801061e4:	6a 53                	push   $0x53
  jmp alltraps
801061e6:	e9 2c f8 ff ff       	jmp    80105a17 <alltraps>
...
801061ed:	6a 54                	push   $0x54
  jmp alltraps
801061ef:	e9 23 f8 ff ff       	jmp    80105a17 <alltraps>
...
801061f6:	6a 55                	push   $0x55
  jmp alltraps
801061f8:	e9 1a f8 ff ff       	jmp    80105a17 <alltraps>
...
801061ff:	6a 56                	push   $0x56
  jmp alltraps
80106201:	e9 11 f8 ff ff       	jmp    80105a17 <alltraps>
...
80106208:	6a 57                	push   $0x57
  jmp alltraps
8010620a:	e9 08 f8 ff ff       	jmp    80105a17 <alltraps>
...
80106211:	6a 58                	push   $0x58
  jmp alltraps
80106213:	e9 ff f7 ff ff       	jmp    80105a17 <alltraps>
...
8010621a:	6a 59                	push   $0x59
  jmp alltraps
8010621c:	e9 f6 f7 ff ff       	jmp    80105a17 <alltraps>
...
80106223:	6a 5a                	push   $0x5a
  jmp alltraps
80106225:	e9 ed f7 ff ff       	jmp    80105a17 <alltraps>
...
8010622c:	6a 5b                	push   $0x5b
  jmp alltraps
8010622e:	e9 e4 f7 ff ff       	jmp    80105a17 <alltraps>
...
80106235:	6a 5c                	push   $0x5c
  jmp alltraps
80106237:	e9 db f7 ff ff       	jmp    80105a17 <alltraps>
...
8010623e:	6a 5d                	push   $0x5d
  jmp alltraps
80106240:	e9 d2 f7 ff ff       	jmp    80105a17 <alltraps>
...
80106247:	6a 5e                	push   $0x5e
  jmp alltraps
80106249:	e9 c9 f7 ff ff       	jmp    80105a17 <alltraps>
...
80106250:	6a 5f                	push   $0x5f
  jmp alltraps
80106252:	e9 c0 f7 ff ff       	jmp    80105a17 <alltraps>
...
80106259:	6a 60                	push   $0x60
  jmp alltraps
8010625b:	e9 b7 f7 ff ff       	jmp    80105a17 <alltraps>
...
80106262:	6a 61                	push   $0x61
  jmp alltraps
80106264:	e9 ae f7 ff ff       	jmp    80105a17 <alltraps>
...
8010626b:	6a 62                	push   $0x62
  jmp alltraps
8010626d:	e9 a5 f7 ff ff       	jmp    80105a17 <alltraps>
...
80106274:	6a 63                	push   $0x63
  jmp alltraps
80106276:	e9 9c f7 ff ff       	jmp    80105a17 <alltraps>
...
8010627d:	6a 64                	push   $0x64
  jmp alltraps
8010627f:	e9 93 f7 ff ff       	jmp    80105a17 <alltraps>
...
80106286:	6a 65                	push   $0x65
  jmp alltraps
80106288:	e9 8a f7 ff ff       	jmp    80105a17 <alltraps>
...
8010628f:	6a 66                	push   $0x66
  jmp alltraps
80106291:	e9 81 f7 ff ff       	jmp    80105a17 <alltraps>
...
80106298:	6a 67                	push   $0x67
  jmp alltraps
8010629a:	e9 78 f7 ff ff       	jmp    80105a17 <alltraps>
...
801062a1:	6a 68                	push   $0x68
  jmp alltraps
801062a3:	e9 6f f7 ff ff       	jmp    80105a17 <alltraps>
...
801062aa:	6a 69                	push   $0x69
  jmp alltraps
801062ac:	e9 66 f7 ff ff       	jmp    80105a17 <alltraps>
...
801062b3:	6a 6a                	push   $0x6a
  jmp alltraps
801062b5:	e9 5d f7 ff ff       	jmp    80105a17 <alltraps>
...
801062bc:	6a 6b                	push   $0x6b
  jmp alltraps
801062be:	e9 54 f7 ff ff       	jmp    80105a17 <alltraps>
...
801062c5:	6a 6c                	push   $0x6c
  jmp alltraps
801062c7:	e9 4b f7 ff ff       	jmp    80105a17 <alltraps>
...
801062ce:	6a 6d                	push   $0x6d
  jmp alltraps
801062d0:	e9 42 f7 ff ff       	jmp    80105a17 <alltraps>
...
801062d7:	6a 6e                	push   $0x6e
  jmp alltraps
801062d9:	e9 39 f7 ff ff       	jmp    80105a17 <alltraps>
...
801062e0:	6a 6f                	push   $0x6f
  jmp alltraps
801062e2:	e9 30 f7 ff ff       	jmp    80105a17 <alltraps>
...
801062e9:	6a 70                	push   $0x70
  jmp alltraps
801062eb:	e9 27 f7 ff ff       	jmp    80105a17 <alltraps>
...
801062f2:	6a 71                	push   $0x71
  jmp alltraps
801062f4:	e9 1e f7 ff ff       	jmp    80105a17 <alltraps>
...
801062fb:	6a 72                	push   $0x72
  jmp alltraps
801062fd:	e9 15 f7 ff ff       	jmp    80105a17 <alltraps>
...
80106304:	6a 73                	push   $0x73
  jmp alltraps
80106306:	e9 0c f7 ff ff       	jmp    80105a17 <alltraps>
...
8010630d:	6a 74                	push   $0x74
  jmp alltraps
8010630f:	e9 03 f7 ff ff       	jmp    80105a17 <alltraps>
...
80106316:	6a 75                	push   $0x75
  jmp alltraps
80106318:	e9 fa f6 ff ff       	jmp    80105a17 <alltraps>
...
8010631f:	6a 76                	push   $0x76
  jmp alltraps
80106321:	e9 f1 f6 ff ff       	jmp    80105a17 <alltraps>
...
80106328:	6a 77                	push   $0x77
  jmp alltraps
8010632a:	e9 e8 f6 ff ff       	jmp    80105a17 <alltraps>
...
80106331:	6a 78                	push   $0x78
  jmp alltraps
80106333:	e9 df f6 ff ff       	jmp    80105a17 <alltraps>
...
8010633a:	6a 79                	push   $0x79
  jmp alltraps
8010633c:	e9 d6 f6 ff ff       	jmp    80105a17 <alltraps>
...
80106343:	6a 7a                	push   $0x7a
  jmp alltraps
80106345:	e9 cd f6 ff ff       	jmp    80105a17 <alltraps>
...
8010634c:	6a 7b                	push   $0x7b
  jmp alltraps
8010634e:	e9 c4 f6 ff ff       	jmp    80105a17 <alltraps>
...
80106355:	6a 7c                	push   $0x7c
  jmp alltraps
80106357:	e9 bb f6 ff ff       	jmp    80105a17 <alltraps>
...
8010635e:	6a 7d                	push   $0x7d
  jmp alltraps
80106360:	e9 b2 f6 ff ff       	jmp    80105a17 <alltraps>
...
80106367:	6a 7e                	push   $0x7e
  jmp alltraps
80106369:	e9 a9 f6 ff ff       	jmp    80105a17 <alltraps>
...
80106370:	6a 7f                	push   $0x7f
  jmp alltraps
80106372:	e9 a0 f6 ff ff       	jmp    80105a17 <alltraps>
...
80106379:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010637e:	e9 94 f6 ff ff       	jmp    80105a17 <alltraps>
...
80106385:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010638a:	e9 88 f6 ff ff       	jmp    80105a17 <alltraps>
...
80106391:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106396:	e9 7c f6 ff ff       	jmp    80105a17 <alltraps>
...
8010639d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063a2:	e9 70 f6 ff ff       	jmp    80105a17 <alltraps>
...
801063a9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063ae:	e9 64 f6 ff ff       	jmp    80105a17 <alltraps>
...
801063b5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801063ba:	e9 58 f6 ff ff       	jmp    80105a17 <alltraps>
...
801063c1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801063c6:	e9 4c f6 ff ff       	jmp    80105a17 <alltraps>
...
801063cd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801063d2:	e9 40 f6 ff ff       	jmp    80105a17 <alltraps>
...
801063d9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801063de:	e9 34 f6 ff ff       	jmp    80105a17 <alltraps>
...
801063e5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801063ea:	e9 28 f6 ff ff       	jmp    80105a17 <alltraps>
...
801063f1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801063f6:	e9 1c f6 ff ff       	jmp    80105a17 <alltraps>
...
801063fd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106402:	e9 10 f6 ff ff       	jmp    80105a17 <alltraps>
...
80106409:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010640e:	e9 04 f6 ff ff       	jmp    80105a17 <alltraps>
...
80106415:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010641a:	e9 f8 f5 ff ff       	jmp    80105a17 <alltraps>
...
80106421:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106426:	e9 ec f5 ff ff       	jmp    80105a17 <alltraps>
...
8010642d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106432:	e9 e0 f5 ff ff       	jmp    80105a17 <alltraps>
...
80106439:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010643e:	e9 d4 f5 ff ff       	jmp    80105a17 <alltraps>
...
80106445:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010644a:	e9 c8 f5 ff ff       	jmp    80105a17 <alltraps>
...
80106451:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106456:	e9 bc f5 ff ff       	jmp    80105a17 <alltraps>
...
8010645d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106462:	e9 b0 f5 ff ff       	jmp    80105a17 <alltraps>
...
80106469:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010646e:	e9 a4 f5 ff ff       	jmp    80105a17 <alltraps>
...
80106475:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010647a:	e9 98 f5 ff ff       	jmp    80105a17 <alltraps>
...
80106481:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106486:	e9 8c f5 ff ff       	jmp    80105a17 <alltraps>
...
8010648d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106492:	e9 80 f5 ff ff       	jmp    80105a17 <alltraps>
...
80106499:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010649e:	e9 74 f5 ff ff       	jmp    80105a17 <alltraps>
...
801064a5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064aa:	e9 68 f5 ff ff       	jmp    80105a17 <alltraps>
...
801064b1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801064b6:	e9 5c f5 ff ff       	jmp    80105a17 <alltraps>
...
801064bd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801064c2:	e9 50 f5 ff ff       	jmp    80105a17 <alltraps>
...
801064c9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801064ce:	e9 44 f5 ff ff       	jmp    80105a17 <alltraps>
...
801064d5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801064da:	e9 38 f5 ff ff       	jmp    80105a17 <alltraps>
...
801064e1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801064e6:	e9 2c f5 ff ff       	jmp    80105a17 <alltraps>
...
801064ed:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801064f2:	e9 20 f5 ff ff       	jmp    80105a17 <alltraps>
...
801064f9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801064fe:	e9 14 f5 ff ff       	jmp    80105a17 <alltraps>
...
80106505:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010650a:	e9 08 f5 ff ff       	jmp    80105a17 <alltraps>
...
80106511:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106516:	e9 fc f4 ff ff       	jmp    80105a17 <alltraps>
...
8010651d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106522:	e9 f0 f4 ff ff       	jmp    80105a17 <alltraps>
...
80106529:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010652e:	e9 e4 f4 ff ff       	jmp    80105a17 <alltraps>
...
80106535:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010653a:	e9 d8 f4 ff ff       	jmp    80105a17 <alltraps>
...
80106541:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106546:	e9 cc f4 ff ff       	jmp    80105a17 <alltraps>
...
8010654d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106552:	e9 c0 f4 ff ff       	jmp    80105a17 <alltraps>
...
80106559:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010655e:	e9 b4 f4 ff ff       	jmp    80105a17 <alltraps>
...
80106565:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010656a:	e9 a8 f4 ff ff       	jmp    80105a17 <alltraps>
...
80106571:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106576:	e9 9c f4 ff ff       	jmp    80105a17 <alltraps>
...
8010657d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106582:	e9 90 f4 ff ff       	jmp    80105a17 <alltraps>
...
80106589:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010658e:	e9 84 f4 ff ff       	jmp    80105a17 <alltraps>
...
80106595:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010659a:	e9 78 f4 ff ff       	jmp    80105a17 <alltraps>
...
801065a1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065a6:	e9 6c f4 ff ff       	jmp    80105a17 <alltraps>
...
801065ad:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801065b2:	e9 60 f4 ff ff       	jmp    80105a17 <alltraps>
...
801065b9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801065be:	e9 54 f4 ff ff       	jmp    80105a17 <alltraps>
...
801065c5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801065ca:	e9 48 f4 ff ff       	jmp    80105a17 <alltraps>
...
801065d1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801065d6:	e9 3c f4 ff ff       	jmp    80105a17 <alltraps>
...
801065dd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801065e2:	e9 30 f4 ff ff       	jmp    80105a17 <alltraps>
...
801065e9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801065ee:	e9 24 f4 ff ff       	jmp    80105a17 <alltraps>
...
801065f5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801065fa:	e9 18 f4 ff ff       	jmp    80105a17 <alltraps>
...
80106601:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106606:	e9 0c f4 ff ff       	jmp    80105a17 <alltraps>
...
8010660d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106612:	e9 00 f4 ff ff       	jmp    80105a17 <alltraps>
...
80106619:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010661e:	e9 f4 f3 ff ff       	jmp    80105a17 <alltraps>
...
80106625:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010662a:	e9 e8 f3 ff ff       	jmp    80105a17 <alltraps>
...
80106631:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106636:	e9 dc f3 ff ff       	jmp    80105a17 <alltraps>
...
8010663d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106642:	e9 d0 f3 ff ff       	jmp    80105a17 <alltraps>
...
80106649:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010664e:	e9 c4 f3 ff ff       	jmp    80105a17 <alltraps>
...
80106655:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010665a:	e9 b8 f3 ff ff       	jmp    80105a17 <alltraps>
...
80106661:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106666:	e9 ac f3 ff ff       	jmp    80105a17 <alltraps>
...
8010666d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106672:	e9 a0 f3 ff ff       	jmp    80105a17 <alltraps>
...
80106679:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010667e:	e9 94 f3 ff ff       	jmp    80105a17 <alltraps>
...
80106685:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010668a:	e9 88 f3 ff ff       	jmp    80105a17 <alltraps>
...
80106691:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106696:	e9 7c f3 ff ff       	jmp    80105a17 <alltraps>
...
8010669d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066a2:	e9 70 f3 ff ff       	jmp    80105a17 <alltraps>
...
801066a9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066ae:	e9 64 f3 ff ff       	jmp    80105a17 <alltraps>
...
801066b5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801066ba:	e9 58 f3 ff ff       	jmp    80105a17 <alltraps>
...
801066c1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801066c6:	e9 4c f3 ff ff       	jmp    80105a17 <alltraps>
...
801066cd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801066d2:	e9 40 f3 ff ff       	jmp    80105a17 <alltraps>
...
801066d9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801066de:	e9 34 f3 ff ff       	jmp    80105a17 <alltraps>
...
801066e5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801066ea:	e9 28 f3 ff ff       	jmp    80105a17 <alltraps>
...
801066f1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801066f6:	e9 1c f3 ff ff       	jmp    80105a17 <alltraps>
...
801066fd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106702:	e9 10 f3 ff ff       	jmp    80105a17 <alltraps>
...
80106709:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010670e:	e9 04 f3 ff ff       	jmp    80105a17 <alltraps>
...
80106715:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010671a:	e9 f8 f2 ff ff       	jmp    80105a17 <alltraps>
...
80106721:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106726:	e9 ec f2 ff ff       	jmp    80105a17 <alltraps>
...
8010672d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106732:	e9 e0 f2 ff ff       	jmp    80105a17 <alltraps>
...
80106739:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010673e:	e9 d4 f2 ff ff       	jmp    80105a17 <alltraps>
...
80106745:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010674a:	e9 c8 f2 ff ff       	jmp    80105a17 <alltraps>
...
80106751:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106756:	e9 bc f2 ff ff       	jmp    80105a17 <alltraps>
...
8010675d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106762:	e9 b0 f2 ff ff       	jmp    80105a17 <alltraps>
...
80106769:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010676e:	e9 a4 f2 ff ff       	jmp    80105a17 <alltraps>
...
80106775:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010677a:	e9 98 f2 ff ff       	jmp    80105a17 <alltraps>
...
80106781:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106786:	e9 8c f2 ff ff       	jmp    80105a17 <alltraps>
...
8010678d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106792:	e9 80 f2 ff ff       	jmp    80105a17 <alltraps>
...
80106799:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010679e:	e9 74 f2 ff ff       	jmp    80105a17 <alltraps>
...
801067a5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067aa:	e9 68 f2 ff ff       	jmp    80105a17 <alltraps>
...
801067b1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801067b6:	e9 5c f2 ff ff       	jmp    80105a17 <alltraps>
...
801067bd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801067c2:	e9 50 f2 ff ff       	jmp    80105a17 <alltraps>
...
801067c9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801067ce:	e9 44 f2 ff ff       	jmp    80105a17 <alltraps>
...
801067d5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801067da:	e9 38 f2 ff ff       	jmp    80105a17 <alltraps>
...
801067e1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801067e6:	e9 2c f2 ff ff       	jmp    80105a17 <alltraps>
...
801067ed:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801067f2:	e9 20 f2 ff ff       	jmp    80105a17 <alltraps>
...
801067f9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801067fe:	e9 14 f2 ff ff       	jmp    80105a17 <alltraps>
...
80106805:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010680a:	e9 08 f2 ff ff       	jmp    80105a17 <alltraps>
...
80106811:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106816:	e9 fc f1 ff ff       	jmp    80105a17 <alltraps>
...
8010681d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106822:	e9 f0 f1 ff ff       	jmp    80105a17 <alltraps>
...
80106829:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010682e:	e9 e4 f1 ff ff       	jmp    80105a17 <alltraps>
...
80106835:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010683a:	e9 d8 f1 ff ff       	jmp    80105a17 <alltraps>
...
80106841:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106846:	e9 cc f1 ff ff       	jmp    80105a17 <alltraps>
...
8010684d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106852:	e9 c0 f1 ff ff       	jmp    80105a17 <alltraps>
...
80106859:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010685e:	e9 b4 f1 ff ff       	jmp    80105a17 <alltraps>
...
80106865:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010686a:	e9 a8 f1 ff ff       	jmp    80105a17 <alltraps>
...
80106871:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106876:	e9 9c f1 ff ff       	jmp    80105a17 <alltraps>
...
8010687d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106882:	e9 90 f1 ff ff       	jmp    80105a17 <alltraps>
...
80106889:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010688e:	e9 84 f1 ff ff       	jmp    80105a17 <alltraps>
...
80106895:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010689a:	e9 78 f1 ff ff       	jmp    80105a17 <alltraps>
...
801068a1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068a6:	e9 6c f1 ff ff       	jmp    80105a17 <alltraps>
...
801068ad:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801068b2:	e9 60 f1 ff ff       	jmp    80105a17 <alltraps>
...
801068b9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801068be:	e9 54 f1 ff ff       	jmp    80105a17 <alltraps>
...
801068c5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801068ca:	e9 48 f1 ff ff       	jmp    80105a17 <alltraps>
...
801068d1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801068d6:	e9 3c f1 ff ff       	jmp    80105a17 <alltraps>
...
801068dd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801068e2:	e9 30 f1 ff ff       	jmp    80105a17 <alltraps>
...
801068e9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801068ee:	e9 24 f1 ff ff       	jmp    80105a17 <alltraps>
...
801068f5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801068fa:	e9 18 f1 ff ff       	jmp    80105a17 <alltraps>
...
80106901:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106906:	e9 0c f1 ff ff       	jmp    80105a17 <alltraps>
...
8010690d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106912:	e9 00 f1 ff ff       	jmp    80105a17 <alltraps>
...
80106919:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010691e:	e9 f4 f0 ff ff       	jmp    80105a17 <alltraps>
...
80106925:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010692a:	e9 e8 f0 ff ff       	jmp    80105a17 <alltraps>
...
80106931:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106936:	e9 dc f0 ff ff       	jmp    80105a17 <alltraps>
...
8010693d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106942:	e9 d0 f0 ff ff       	jmp    80105a17 <alltraps>
...
80106949:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010694e:	e9 c4 f0 ff ff       	jmp    80105a17 <alltraps>
...
80106955:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010695a:	e9 b8 f0 ff ff       	jmp    80105a17 <alltraps>
...
80106961:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106966:	e9 ac f0 ff ff       	jmp    80105a17 <alltraps>
...
8010696d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106972:	e9 a0 f0 ff ff       	jmp    80105a17 <alltraps>
...
80106995:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106998:	39 d3                	cmp    %edx,%ebx
8010699a:	73 49                	jae    801069e5 <deallocuvm.part.0+0x65>
8010699c:	89 c7                	mov    %eax,%edi
8010699e:	eb 0c                	jmp    801069ac <deallocuvm.part.0+0x2c>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801069a0:	83 c0 01             	add    $0x1,%eax
801069a3:	c1 e0 16             	shl    $0x16,%eax
801069a6:	89 c3                	mov    %eax,%ebx
  for(; a  < oldsz; a += PGSIZE){
801069a8:	39 da                	cmp    %ebx,%edx
801069aa:	76 39                	jbe    801069e5 <deallocuvm.part.0+0x65>
  pde = &pgdir[PDX(va)];
801069ac:	89 d8                	mov    %ebx,%eax
801069ae:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
801069b1:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
801069b4:	f6 c1 01             	test   $0x1,%cl
801069b7:	74 e7                	je     801069a0 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
801069b9:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801069bb:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
801069c1:	c1 ee 0a             	shr    $0xa,%esi
801069c4:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
801069ca:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
    if(!pte)
801069d1:	85 f6                	test   %esi,%esi
801069d3:	74 cb                	je     801069a0 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
801069d5:	8b 06                	mov    (%esi),%eax
801069d7:	a8 01                	test   $0x1,%al
801069d9:	75 15                	jne    801069f0 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
801069db:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801069e1:	39 da                	cmp    %ebx,%edx
801069e3:	77 c7                	ja     801069ac <deallocuvm.part.0+0x2c>
      kfree(v);
      *pte = 0;
    }
  }
...
801069e5:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
801069ef:	c3                   	ret    
      if(pa == 0)
801069f0:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801069f5:	74 25                	je     80106a1c <deallocuvm.part.0+0x9c>
      kfree(v);
801069f7:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
801069fa:	05 00 00 00 80       	add    $0x80000000,%eax
801069ff:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106a02:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80106a08:	50                   	push   %eax
80106a09:	e8 b2 ba ff ff       	call   801024c0 <kfree>
      *pte = 0;
80106a0e:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  for(; a  < oldsz; a += PGSIZE){
80106a14:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106a17:	83 c4 10             	add    $0x10,%esp
80106a1a:	eb 8c                	jmp    801069a8 <deallocuvm.part.0+0x28>
        panic("kfree");
80106a1c:	83 ec 0c             	sub    $0xc,%esp
80106a1f:	68 e6 75 10 80       	push   $0x801075e6
80106a24:	e8 57 99 ff ff       	call   80100380 <panic>
...
{
80106a3e:	83 ec 1c             	sub    $0x1c,%esp
80106a41:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106a44:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
80106a48:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106a4d:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106a50:	8b 45 08             	mov    0x8(%ebp),%eax
80106a53:	29 d8                	sub    %ebx,%eax
80106a55:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106a58:	eb 3d                	jmp    80106a97 <mappages+0x67>
...
80106a62:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80106a67:	c1 ea 0a             	shr    $0xa,%edx
80106a6a:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80106a70:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106a77:	85 c0                	test   %eax,%eax
80106a79:	74 75                	je     80106af0 <mappages+0xc0>
    if(*pte & PTE_P)
80106a7b:	f6 00 01             	testb  $0x1,(%eax)
80106a7e:	0f 85 86 00 00 00    	jne    80106b0a <mappages+0xda>
    *pte = pa | perm | PTE_P;
80106a84:	0b 75 0c             	or     0xc(%ebp),%esi
80106a87:	83 ce 01             	or     $0x1,%esi
80106a8a:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106a8c:	3b 5d dc             	cmp    -0x24(%ebp),%ebx
80106a8f:	74 6f                	je     80106b00 <mappages+0xd0>
    a += PGSIZE;
80106a91:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80106a97:	8b 45 e0             	mov    -0x20(%ebp),%eax
  pde = &pgdir[PDX(va)];
80106a9a:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106a9d:	8d 34 18             	lea    (%eax,%ebx,1),%esi
80106aa0:	89 d8                	mov    %ebx,%eax
80106aa2:	c1 e8 16             	shr    $0x16,%eax
80106aa5:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
80106aa8:	8b 07                	mov    (%edi),%eax
80106aaa:	a8 01                	test   $0x1,%al
80106aac:	75 b2                	jne    80106a60 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80106aae:	e8 cd bb ff ff       	call   80102680 <kalloc>
80106ab3:	85 c0                	test   %eax,%eax
80106ab5:	74 39                	je     80106af0 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80106ab7:	83 ec 04             	sub    $0x4,%esp
80106aba:	89 45 d8             	mov    %eax,-0x28(%ebp)
80106abd:	68 00 10 00 00       	push   $0x1000
80106ac2:	6a 00                	push   $0x0
80106ac4:	50                   	push   %eax
80106ac5:	e8 96 db ff ff       	call   80104660 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106aca:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
80106acd:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106ad0:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80106ad6:	83 c8 07             	or     $0x7,%eax
80106ad9:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
80106adb:	89 d8                	mov    %ebx,%eax
80106add:	c1 e8 0a             	shr    $0xa,%eax
80106ae0:	25 fc 0f 00 00       	and    $0xffc,%eax
80106ae5:	01 d0                	add    %edx,%eax
80106ae7:	eb 92                	jmp    80106a7b <mappages+0x4b>
...
80106b0d:	68 68 7d 10 80       	push   $0x80107d68
...
80106b23:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b26:	e8 25 ce ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
80106b2b:	ba 2f 00 00 00       	mov    $0x2f,%edx
80106b30:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106b36:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106b3a:	c7 80 78 18 11 80 ff 	movl   $0xffff,-0x7feee788(%eax)
80106b41:	ff 00 00 
80106b44:	c7 80 7c 18 11 80 00 	movl   $0xcf9a00,-0x7feee784(%eax)
80106b4b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106b4e:	c7 80 80 18 11 80 ff 	movl   $0xffff,-0x7feee780(%eax)
80106b55:	ff 00 00 
80106b58:	c7 80 84 18 11 80 00 	movl   $0xcf9200,-0x7feee77c(%eax)
80106b5f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106b62:	c7 80 88 18 11 80 ff 	movl   $0xffff,-0x7feee778(%eax)
80106b69:	ff 00 00 
80106b6c:	c7 80 8c 18 11 80 00 	movl   $0xcffa00,-0x7feee774(%eax)
80106b73:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106b76:	c7 80 90 18 11 80 ff 	movl   $0xffff,-0x7feee770(%eax)
80106b7d:	ff 00 00 
80106b80:	c7 80 94 18 11 80 00 	movl   $0xcff200,-0x7feee76c(%eax)
80106b87:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106b8a:	05 70 18 11 80       	add    $0x80111870,%eax
  pd[1] = (uint)p;
...
80106bb0:	a1 24 45 11 80       	mov    0x80114524,%eax
80106bb5:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80106bd9:	0f 84 da 00 00 00    	je     80106cb9 <switchuvm+0xf9>
  if(p->pgdir == 0)
80106bdf:	8b 46 04             	mov    0x4(%esi),%eax
80106be2:	85 c0                	test   %eax,%eax
80106be4:	0f 84 c2 00 00 00    	je     80106cac <switchuvm+0xec>
  pushcli();
80106bea:	e8 61 d8 ff ff       	call   80104450 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106bef:	e8 fc cc ff ff       	call   801038f0 <mycpu>
80106bf4:	89 c3                	mov    %eax,%ebx
80106bf6:	e8 f5 cc ff ff       	call   801038f0 <mycpu>
80106bfb:	89 c7                	mov    %eax,%edi
80106bfd:	e8 ee cc ff ff       	call   801038f0 <mycpu>
80106c02:	83 c7 08             	add    $0x8,%edi
80106c05:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c08:	e8 e3 cc ff ff       	call   801038f0 <mycpu>
80106c0d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106c10:	ba 67 00 00 00       	mov    $0x67,%edx
80106c15:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106c1c:	83 c0 08             	add    $0x8,%eax
80106c1f:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c26:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c2b:	83 c1 08             	add    $0x8,%ecx
80106c2e:	c1 e8 18             	shr    $0x18,%eax
80106c31:	c1 e9 10             	shr    $0x10,%ecx
80106c34:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106c3a:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106c40:	b9 99 40 00 00       	mov    $0x4099,%ecx
80106c45:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106c4c:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80106c51:	e8 9a cc ff ff       	call   801038f0 <mycpu>
80106c56:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106c5d:	e8 8e cc ff ff       	call   801038f0 <mycpu>
80106c62:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106c66:	8b 5e 08             	mov    0x8(%esi),%ebx
80106c69:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106c6f:	e8 7c cc ff ff       	call   801038f0 <mycpu>
80106c74:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c77:	e8 74 cc ff ff       	call   801038f0 <mycpu>
80106c7c:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106c80:	b8 28 00 00 00       	mov    $0x28,%eax
80106c85:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106c88:	8b 46 04             	mov    0x4(%esi),%eax
...
80106c99:	5d                   	pop    %ebp
  popcli();
80106c9a:	e9 01 d8 ff ff       	jmp    801044a0 <popcli>
    panic("switchuvm: no process");
80106c9f:	83 ec 0c             	sub    $0xc,%esp
80106ca2:	68 6e 7d 10 80       	push   $0x80107d6e
80106ca7:	e8 d4 96 ff ff       	call   80100380 <panic>
    panic("switchuvm: no pgdir");
80106cac:	83 ec 0c             	sub    $0xc,%esp
80106caf:	68 99 7d 10 80       	push   $0x80107d99
80106cb4:	e8 c7 96 ff ff       	call   80100380 <panic>
    panic("switchuvm: no kstack");
80106cb9:	83 ec 0c             	sub    $0xc,%esp
80106cbc:	68 84 7d 10 80       	push   $0x80107d84
...
80106cdc:	8b 75 10             	mov    0x10(%ebp),%esi
80106cdf:	8b 7d 08             	mov    0x8(%ebp),%edi
80106ce2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106ce5:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106ceb:	77 4b                	ja     80106d38 <inituvm+0x68>
  mem = kalloc();
80106ced:	e8 8e b9 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
80106cf2:	83 ec 04             	sub    $0x4,%esp
80106cf5:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
80106cfa:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106cfc:	6a 00                	push   $0x0
80106cfe:	50                   	push   %eax
80106cff:	e8 5c d9 ff ff       	call   80104660 <memset>
...
80106d13:	31 d2                	xor    %edx,%edx
80106d15:	50                   	push   %eax
80106d16:	89 f8                	mov    %edi,%eax
80106d18:	e8 13 fd ff ff       	call   80106a30 <mappages>
  memmove(mem, init, sz);
80106d1d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106d20:	89 75 10             	mov    %esi,0x10(%ebp)
80106d23:	83 c4 10             	add    $0x10,%esp
80106d26:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106d29:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80106d32:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d33:	e9 c8 d9 ff ff       	jmp    80104700 <memmove>
    panic("inituvm: more than a page");
80106d38:	83 ec 0c             	sub    $0xc,%esp
80106d3b:	68 ad 7d 10 80       	push   $0x80107dad
80106d40:	e8 3b 96 ff ff       	call   80100380 <panic>
...
80106d5c:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80106d5f:	a9 ff 0f 00 00       	test   $0xfff,%eax
80106d64:	0f 85 bb 00 00 00    	jne    80106e25 <loaduvm+0xd5>
  for(i = 0; i < sz; i += PGSIZE){
80106d6a:	01 f0                	add    %esi,%eax
80106d6c:	89 f3                	mov    %esi,%ebx
80106d6e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106d71:	8b 45 14             	mov    0x14(%ebp),%eax
80106d74:	01 f0                	add    %esi,%eax
80106d76:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80106d79:	85 f6                	test   %esi,%esi
80106d7b:	0f 84 87 00 00 00    	je     80106e08 <loaduvm+0xb8>
80106d81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
80106d88:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  if(*pde & PTE_P){
80106d8b:	8b 4d 08             	mov    0x8(%ebp),%ecx
80106d8e:	29 d8                	sub    %ebx,%eax
  pde = &pgdir[PDX(va)];
80106d90:	89 c2                	mov    %eax,%edx
80106d92:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80106d95:	8b 14 91             	mov    (%ecx,%edx,4),%edx
80106d98:	f6 c2 01             	test   $0x1,%dl
80106d9b:	75 13                	jne    80106db0 <loaduvm+0x60>
      panic("loaduvm: address should exist");
80106d9d:	83 ec 0c             	sub    $0xc,%esp
80106da0:	68 c7 7d 10 80       	push   $0x80107dc7
80106da5:	e8 d6 95 ff ff       	call   80100380 <panic>
80106daa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80106db0:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106db3:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80106db9:	25 fc 0f 00 00       	and    $0xffc,%eax
80106dbe:	8d 84 02 00 00 00 80 	lea    -0x80000000(%edx,%eax,1),%eax
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106dc5:	85 c0                	test   %eax,%eax
80106dc7:	74 d4                	je     80106d9d <loaduvm+0x4d>
    pa = PTE_ADDR(*pte);
...
80106deb:	ff 75 10             	push   0x10(%ebp)
80106dee:	e8 9d ac ff ff       	call   80101a90 <readi>
80106df3:	83 c4 10             	add    $0x10,%esp
80106df6:	39 f8                	cmp    %edi,%eax
80106df8:	75 1e                	jne    80106e18 <loaduvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106dfa:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106e00:	89 f0                	mov    %esi,%eax
80106e02:	29 d8                	sub    %ebx,%eax
80106e04:	39 c6                	cmp    %eax,%esi
80106e06:	77 80                	ja     80106d88 <loaduvm+0x38>
}
...
80106e28:	68 68 7e 10 80       	push   $0x80107e68
...
{
80106e4c:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80106e4f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e52:	85 c0                	test   %eax,%eax
80106e54:	0f 88 b6 00 00 00    	js     80106f10 <allocuvm+0xd0>
  if(newsz < oldsz)
80106e5a:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80106e5d:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106e60:	0f 82 9a 00 00 00    	jb     80106f00 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106e66:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106e6c:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106e72:	39 75 10             	cmp    %esi,0x10(%ebp)
80106e75:	77 44                	ja     80106ebb <allocuvm+0x7b>
80106e77:	e9 87 00 00 00       	jmp    80106f03 <allocuvm+0xc3>
...
80106e8b:	e8 d0 d7 ff ff       	call   80104660 <memset>
...
80106ea4:	e8 87 fb ff ff       	call   80106a30 <mappages>
...
80106eb9:	76 48                	jbe    80106f03 <allocuvm+0xc3>
    mem = kalloc();
80106ebb:	e8 c0 b7 ff ff       	call   80102680 <kalloc>
...
80106ec9:	68 e5 7d 10 80       	push   $0x80107de5
80106ece:	e8 cd 97 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
80106ee5:	e8 96 fa ff ff       	call   80106980 <deallocuvm.part.0>
      return 0;
...
80106f2b:	68 fd 7d 10 80       	push   $0x80107dfd
80106f30:	e8 6b 97 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
80106f47:	e8 34 fa ff ff       	call   80106980 <deallocuvm.part.0>
      kfree(mem);
80106f4c:	83 ec 0c             	sub    $0xc,%esp
80106f4f:	53                   	push   %ebx
80106f50:	e8 6b b5 ff ff       	call   801024c0 <kfree>
      return 0;
...
80106f80:	5d                   	pop    %ebp
80106f81:	e9 fa f9 ff ff       	jmp    80106980 <deallocuvm.part.0>
...
80106fbb:	e8 c0 f9 ff ff       	call   80106980 <deallocuvm.part.0>
...
80106fee:	e8 cd b4 ff ff       	call   801024c0 <kfree>
...
80107003:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107004:	e9 b7 b4 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80107009:	83 ec 0c             	sub    $0xc,%esp
8010700c:	68 19 7e 10 80       	push   $0x80107e19
...
80107051:	ff 73 0c             	push   0xc(%ebx)
80107054:	8b 13                	mov    (%ebx),%edx
80107056:	50                   	push   %eax
80107057:	29 c1                	sub    %eax,%ecx
80107059:	89 f0                	mov    %esi,%eax
8010705b:	e8 d0 f9 ff ff       	call   80106a30 <mappages>
...
8010706a:	81 fb c0 a4 10 80    	cmp    $0x8010a4c0,%ebx
...
801070ab:	a3 24 45 11 80       	mov    %eax,0x80114524
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801070dc:	68 2a 7e 10 80       	push   $0x80107e2a
...
80107123:	0f 84 bd 00 00 00    	je     801071e6 <copyuvm+0xd6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80107152:	68 34 7e 10 80       	push   $0x80107e34
...
801071b0:	e8 4b d5 ff ff       	call   80104700 <memmove>
...
801071cb:	e8 60 f8 ff ff       	call   80106a30 <mappages>
...
801071e0:	0f 87 5a ff ff ff    	ja     80107140 <copyuvm+0x30>
  return d;
...
801071fc:	e8 bf b2 ff ff       	call   801024c0 <kfree>
      goto bad;
...
80107227:	68 4e 7e 10 80       	push   $0x80107e4e
...
80107254:	0f 84 00 01 00 00    	je     8010735a <uva2ka.cold>
  return &pgtab[PTX(va)];
...
80107264:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
80107269:	8b 84 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%eax
  if((*pte & PTE_U) == 0)
...
80107277:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
8010727a:	05 00 00 00 80       	add    $0x80000000,%eax
8010727f:	83 fa 05             	cmp    $0x5,%edx
80107282:	ba 00 00 00 00       	mov    $0x0,%edx
80107287:	0f 45 c2             	cmovne %edx,%eax
}
8010728a:	c3                   	ret    
...
801072a6:	e9 a5 00 00 00       	jmp    80107350 <copyout+0xc0>
...
801072c2:	74 75                	je     80107339 <copyout+0xa9>
      return -1;
    n = PGSIZE - (va - va0);
...
801072c6:	89 55 10             	mov    %edx,0x10(%ebp)
    n = PGSIZE - (va - va0);
801072c9:	29 c3                	sub    %eax,%ebx
801072cb:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801072d1:	39 f3                	cmp    %esi,%ebx
801072d3:	0f 47 de             	cmova  %esi,%ebx
    memmove(pa0 + (va - va0), buf, n);
801072d6:	29 f8                	sub    %edi,%eax
801072d8:	83 ec 04             	sub    $0x4,%esp
801072db:	01 c1                	add    %eax,%ecx
801072dd:	53                   	push   %ebx
801072de:	52                   	push   %edx
801072df:	51                   	push   %ecx
801072e0:	e8 1b d4 ff ff       	call   80104700 <memmove>
    len -= n;
    buf += n;
...
801072f5:	74 59                	je     80107350 <copyout+0xc0>
  if(*pde & PTE_P){
...
8010730d:	0f 84 4e 00 00 00    	je     80107361 <copyout.cold>
  return &pgtab[PTX(va)];
...
8010732d:	83 e1 05             	and    $0x5,%ecx
80107330:	83 f9 05             	cmp    $0x5,%ecx
80107333:	0f 84 77 ff ff ff    	je     801072b0 <copyout+0x20>
  }
  return 0;
}
